...
| `formats/` | Import / export for IFC, glTF, XGF, XKT, LAS, CityJSON, OBJ + MTL, DotBIM, 3D Gaussian Splatting (`.splat`), plus the 2D drawing formats (PDF, DWG, DXF, SVG) and native scene-model and data-model JSON. |
