...
import {math, View} from "../../../../src/viewer"
...
import {LayerGeometryParams} from "./LayerGeometryParams";
...
export class DataTextureLayer {
     ...
     *
     * @param {object} geometryCfg GeometryBucketHandle data (positions, indices, edgeIndices) for the portion.
