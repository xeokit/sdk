...
export class LinesBatchingLayer {
    ...
    drawColorOpaque(drawFlags: DrawFlags, frameContext: FrameContext): void {
        ...
        if (this.#batchingRenderers.fastColorRenderer) {
            this.#batchingRenderers.fastColorRenderer.drawLayer(frameContext, this, RENDER_PASSES.COLOR_OPAQUE);
        }
    }
    ...
    drawColorTransparent(drawFlags: DrawFlags, frameContext: FrameContext): void {
        ...
        if (this.#batchingRenderers.fastColorRenderer) {
            this.#batchingRenderers.fastColorRenderer.drawLayer(frameContext, this, RENDER_PASSES.COLOR_TRANSPARENT);
        }
    }
