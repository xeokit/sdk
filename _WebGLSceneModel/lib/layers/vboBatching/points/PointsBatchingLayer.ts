...
export class PointsBatchingLayer {
    ...
    drawColorOpaque(drawFlags: DrawFlags, frameContext: FrameContext): void {
        ...
        if (this.#pointsBatchingRenderers.fastColorRenderer) {
            this.#pointsBatchingRenderers.fastColorRenderer.drawLayer(frameContext, this, RENDER_PASSES.COLOR_OPAQUE);
        }
    }
    ...
    drawColorTransparent(drawFlags: DrawFlags, frameContext: FrameContext): void {
        ...
        if (this.#pointsBatchingRenderers.fastColorRenderer) {
            this.#pointsBatchingRenderers.fastColorRenderer.drawLayer(frameContext, this, RENDER_PASSES.COLOR_TRANSPARENT);
        }
    }
