...
class TrianglesBatchingRenderers {
    ...
    #fastColorRenderer: TrianglesBatchingColorRenderer;
    ...
    get fastColorRenderer(): TrianglesBatchingColorRenderer {
        if (!this.#fastColorRenderer) {
            this.#fastColorRenderer = new TrianglesBatchingColorRenderer(this.#view, false);
        }
