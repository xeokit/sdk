 ...
 * @private
 */
export class TrianglesBatchingPBRRenderer extends BasicVBOLayerRenderer {
    ...
    getHash() {
        return [this.view.gammaFactor, this.view.getLightsHash(), this.view.getSectionPlanesHash(), (this.#withSAO ? "sao" : "nosao")].join(";");
    }
