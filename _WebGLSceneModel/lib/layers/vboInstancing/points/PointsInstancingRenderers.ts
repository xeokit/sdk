...
export class PointsInstancingRenderers {
    ...
    #view: View;
    #fastColorRenderer: PointsInstancingColorRenderer;
    ...
    get fastColorRenderer(): PointsInstancingColorRenderer {
        if (!this.#fastColorRenderer) {
            this.#fastColorRenderer = new PointsInstancingColorRenderer(this.#view);
        }
