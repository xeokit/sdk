 ...
 *
 * To import an [DTX](https://xeokit.github.io/sdk/docs/pages/GLOSSARY.html#DTX) model into xeokit, use the {@link loadDTX} function, which will load the file into
 * a {@link @xeokit/scene!SceneModel | SceneModel} and a {@link @xeokit/data!DataModel | DataModel}.
 *
 * To export an [DTX](https://xeokit.github.io/sdk/docs/pages/GLOSSARY.html#DTX) model from xeokit, use the {@link saveDTX} function, which will save a
 ...
 * ## Usage
 *
 * In the example below, we'll use {@link loadDTX} to import an [DTX](https://xeokit.github.io/sdk/docs/pages/GLOSSARY.html#DTX) file into a {@link @xeokit/data!DataModel | DataModel} and
