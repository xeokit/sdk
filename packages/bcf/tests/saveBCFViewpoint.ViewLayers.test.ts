...
describe('saveBCFViewpoint', () => {
    ...
    it("Create ViewLayers", () => {
        ...
        const viewLayerDefault = view.createLayer({
            id: "default",
            visible: true
        })
        expect(viewLayerDefault instanceof ViewLayer).toBe(true);

        const viewLayer2 = view.createLayer({
            id: "viewLayer2",
            visible: true
        })
    ...
    it("Save a BCF viewpoint", () => {
        ...
        bcfViewpoint = saveBCFViewpoint({
            view,
            includeLayerIds: ["viewLayer2"],
            excludeLayerIds: ["default"]
        });
