...
module.exports = {
    ...
    moduleNameMapper: {
        ...
        "@xeokit/cityjson2dtx/(.*)$": path.join(__dirname, "../cityjson2dtx/src/$1"),
        ...
        "@xeokit/gltf2dtx/(.*)$": path.join(__dirname, "../gltf2dtx/src/$1"),
        "@xeokit/ifc2dtx/(.*)$": path.join(__dirname, "../ifc2dtx/src/$1"),
        ...
        "@xeokit/las2dtx/(.*)$": path.join(__dirname, "../las2dtx/src/$1"),
