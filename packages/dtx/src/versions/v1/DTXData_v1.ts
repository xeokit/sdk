...
/**
 *  The elements of a [DTX](https://xeokit.github.io/sdk/docs/pages/GLOSSARY.html#dtx) v1.0 file,
 *  unpacked into a set of arrays for parsing.
 *
 *  This interface represents the structure of the DTX v1.0 file format. Although this interface is used
 *  internally, we include it in the API documentation so that it can also serve as a reference to the file format.
 */
export interface DTXData_v1 {
     ...
     * of its geometry's 3D vertex positions in {@link DTXData_v1.positions}.
     *
    ...
    /**
     * For each geometry, a pointer to the start of its portion in {@link DTXData_v1.positions}.
     */
    eachGeometryPositionsBase: Uint32Array;

    /**
     * For each geometry, a pointer to the start of its portion in {@link DTXData_v1.colors}.
     */
    eachGeometryColorsBase: Uint32Array;

    /**
     * For each geometry, a pointer to the start of its portion in {@link DTXData_v1.indices}.
     */
    eachGeometryIndicesBase: Uint32Array;

    /**
     * For each geometry, a pointer to the start of its portion in {@link DTXData_v1.edgeIndices}.
     */
    ...
    /**
     * For each geometry, a pointer to the start of its portion in `DTXData_v1.aabbs`.
     *
     * Each portion is six elements of `DTXData_v1.aabbs`, containing `[minX, minY, minZ, maxX, maxY, maxZ]`.
     *
    ...
    /**
     * For each mesh, a pointer to the start of its portion in {@link DTXData_v1.eachGeometryPositionsBase},
     * {@link DTXData_v1.eachGeometryColorsBase}, {@link DTXData_v1.eachGeometryIndicesBase} and
     * {@link DTXData_v1.eachGeometryEdgeIndicesBase}.
     */
    eachMeshGeometriesBase: Uint32Array;

    /**
     * For each mesh, a pointer to its matrix in {@link DTXData_v1.matrices}.
     *
    ...
    /**
     * For each object, a pointer to its first mesh in {@link DTXData_v1.eachMeshGeometriesBase},
     * {@link DTXData_v1.eachMeshMatricesBase} and {@link DTXData_v1.eachMeshMaterialAttributes}.
     */
