...
export declare class DataObject {
     ...
     * Globally-unique ID.
     *
     * DataObjects are stored by ID in {@link @xeokit/data!Data.objects | Data.objects}, {@link @xeokit/data!Data.rootObjects | Data.rootObjects}, {@link Data.objectsByType | Data.objectsByType} and {@link DataModel.rootObjects | Data.rootObjects}.
     */
    readonly id: string;
    /**
     * Human-readable name.
    ...
    /**
     * The {@link @xeokit/data!Relationship | Relationships} in which this DataObject is the {@link @xeokit/data!Relationship.related} participant.
     *
     * Each DataObject is mapped here by {@link @xeokit/data!Relationship.type | Relationship.type} and sub-mapped by {@link @xeokit/data!Relationship.related | Relationship.related}.
     */
    readonly related: {
        [key: number]: Relationship[];
    };
