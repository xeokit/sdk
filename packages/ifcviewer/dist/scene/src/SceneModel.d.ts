 ...
 * * Contains {@link @xeokit/scene!SceneObject | SceneObjects}, {@link @xeokit/scene!SceneMesh | Meshes}, {@link @xeokit/scene!SceneGeometry | Geometries} and {@link Texture | Textures}.
...
export declare class SceneModel extends Component {
    ...
    /**
     * {@link Texture | Textures} within this SceneModel, each mapped to {@link Texture.id | SceneTexture.id}.
     *
    ...
    /**
     * {@link TextureSet | TextureSets} within this SceneModel, each mapped to {@link TextureSet.id | SceneTextureSet.id}.
     *
    ...
    /**
     *  Internal interface through which a SceneModel can load property updates into a renderers.
     *
     * @internal
     */
     ...
     * * A duplicate component ({@link @xeokit/scene!SceneObject}, {@link @xeokit/scene!SceneMesh}, {@link @xeokit/scene!SceneGeometry}, {@link Texture} etc.) was already created within this SceneModel.
     */
     ...
     *
     * * Stores the new {@link @xeokit/scene!SceneGeometry} in {@link @xeokit/scene!SceneModel.geometries | SceneModel.geometries}.
     * * Use {@link @xeokit/scene!compressGeometryParams} to pre-compress {@link @xeokit/scene!SceneGeometryParams|SceneGeometryParams} into {@link @xeokit/scene!SceneGeometryCompressedParams|SceneGeometryCompressedParams}.
     *
     * ### Usage
     *
     * ````javascript
     ...
     */
    createMesh(meshParams: MeshParams): SceneMesh | SDKError;
    /**
