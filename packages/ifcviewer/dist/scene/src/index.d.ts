 ...
 * comprise {@link @xeokit/scene!SceneObject | SceneObjects}, {@link @xeokit/scene!SceneMesh | Meshes}, {@link @xeokit/scene!SceneGeometry | Geometries}, {@link @xeokit/scene!SceneGeometryBucket | GeometryBuckets}, and {@link Texture | Textures}.
 ...
 *
 * Now that we've built our SceneModel, we can read all of its components. Note that the {@link Texture} and {@link @xeokit/scene!SceneGeometry}
 ...
 * method uses [Basis](https://xeokit.github.io/sdk/docs/pages/GLOSSARY.html#basis) to compress the SceneTexture to KTX2. We can now read that transcoded data
 * back from {@link @SceneTexture.buffers | SceneTexture.buffers}:
 *
 * ````javascript
 * const theTexture = theSceneModel.textures["theColorTexture"];
 *
