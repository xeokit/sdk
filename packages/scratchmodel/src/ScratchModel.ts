...
class ScratchModel extends Component implements Model, BuildableModel {
    ...
    /**
     * Emits an event when this {@link ScratchModel} has already been built.
     *
    ...
    /**
     * Emits an event when this {@link ScratchModel} has been destroyed.
     *
    ...
    /**
     * Creates a new {@link Geometry} within this ScratchModel, from non-compressed geometry parameters.
     *
     * ### Usage
     *
     * ````javascript
    ...
    /**
     * Creates a new {@link Geometry} within this ScratchModel, from pre-compressed geometry parameters.
     *
