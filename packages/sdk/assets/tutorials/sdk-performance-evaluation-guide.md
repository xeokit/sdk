...
| [![Baku 200 static](sdk-performance-evaluation-guide/baku-200-static.png)](https://xeokit.github.io/sdk/examples/streaming/xgf/baku-200-static/?renderer=webgl)<br>[Baku Stadium, 200 Chunks, Static - WebGL](https://xeokit.github.io/sdk/examples/streaming/xgf/baku-200-static/?renderer=webgl)<br>[Baku Stadium, 200 Chunks, Static - WebGPU](https://xeokit.github.io/sdk/examples/streaming/xgf/baku-200-static/?renderer=webgpu) | WebGL or WebGPU, selected by URL | Coarse partitioning baseline, static model upload cost and renderer-backend comparison on the same 200-chunk dataset. |
...
2. Run [Baku Stadium, 200 Chunks, Static - WebGL](https://xeokit.github.io/sdk/examples/streaming/xgf/baku-200-static/?renderer=webgl) and [Baku Stadium, 200 Chunks, Static - WebGPU](https://xeokit.github.io/sdk/examples/streaming/xgf/baku-200-static/?renderer=webgpu) to compare renderer backends on the same static stream dataset.
3. Use [Procedural Cityscape](https://xeokit.github.io/sdk/examples/benchmarks/scene/procedural-cityscape/?renderer=webgl) for high object counts and repeated geometry.
4. Use [Shared Scene](https://xeokit.github.io/sdk/examples/view/renderers/webgl-webgpu-shared-scene/) and [Material Feature Parity](https://xeokit.github.io/sdk/examples/view/renderers/webgl-webgpu-material-parity/) to compare renderer parity after baseline scale tests.
5. Run [SAO Quality](https://xeokit.github.io/sdk/examples/view/renderers/webgl-webgpu-sao-quality/), [Shadow Quality](https://xeokit.github.io/sdk/examples/view/renderers/webgl-webgpu-shadow-quality/), [Transparency Quality](https://xeokit.github.io/sdk/examples/view/renderers/webgl-webgpu-transparency-quality/) and [Style Bins](https://xeokit.github.io/sdk/examples/view/renderers/webgl-webgpu-style-bins/) for effect-specific cost and visual correctness.
6. Use [Create & Destroy Meshes](https://xeokit.github.io/sdk/examples/benchmarks/scene/stress-test/?renderer=webgl) and [WebGPU Creating a 3D Model Benchmark](https://xeokit.github.io/sdk/examples/benchmarks/scene/stress-test-webgpu/?renderer=webgpu) for mutation-heavy applications.
