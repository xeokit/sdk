...
function buildCLITool(moduleId) {
    ...
    fs.copyFileSync(`./src/conversion/${moduleId}/${moduleId}.js`, `./dist/${moduleId}/${moduleId}.js`);
    fs.copyFileSync(`./src/conversion/${moduleId}/${moduleId}_core.ts`, `./dist/${moduleId}/${moduleId}_core.ts`);
}
