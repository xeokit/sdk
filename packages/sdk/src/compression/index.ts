 ...
 *
 * This process is commonly used in mesh compression techniques to reduce the dtxMemory footprint of
 ...
 * storing them in a `Uint16Array` for reduced dtxMemory usage.
 *
