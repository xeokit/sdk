...
import {type SceneModelStats} from "../../../../model/scene";
import {type DataModelStats} from "../../../../model/data";
...
export interface ModelConverterStatsReport {
  ...
  /**
   * A map of {@link model!scene.SceneModel | SceneModel} identifiers to their corresponding statistics.
   */
  sceneModels: {
  ...
  /**
   * A map of {@link model!data.DataModel | DataModel} identifiers to their corresponding statistics.
   */
  dataModels: {
