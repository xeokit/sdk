...
export interface ModelConverterStatsReportOutput {
  ...
  /**
   * The identifier of the associated {@link model!scene.SceneModel | SceneModel}, if applicable.
   */
  sceneModel: string;

  /**
   * The identifier of the associated {@link model!data.DataModel | DataModel}, if applicable.
   */
  dataModel: string;
