...
// `;
//
// import {Exporter} from "../../../base/io";
// import {ModelEncodeParams} from "../../../base/io";
//
// const PORT = 3000;
...
// }
//
// function encoder(params: ModelEncodeParams, options?: any): Promise<any> {
//
...
//         console.log(`📸 Screenshot captured in _gpuMemoryManager. Size: ${screenshotBuffer.length} bytes`);
