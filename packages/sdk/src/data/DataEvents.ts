...
export class DataEvents {
  ...
  /**
   * Emits an event each time a {@link DataModel} is created within the {@link Data}.
   */
  public readonly onDataModelCreated: EventEmitter<Data, DataModel>;

  /**
   * Emits an event each time a {@link DataModel} is destroyed within the {@link Data}.
   */
  public readonly onDataModelDestroyed: EventEmitter<Data, DataModel>;

  /**
   * Emits an event each time a {@link DataObject} is created within the {@link Data}.
   */
  public readonly onDataObjectCreated: EventEmitter<Data, DataObject>;

  /**
   * Emits an event each time a {@link DataObject} is destroyed within the {@link Data}.
   */
