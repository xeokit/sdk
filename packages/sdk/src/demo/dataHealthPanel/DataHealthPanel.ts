...
export class DataHealthPanel extends FloatingPanelBase {
  ...
  /** Network / database glyph — three nodes connected by edges. */
  static iconSvg(): string {
    return `<svg viewBox="0 0 24 24" aria-hidden="true">` +
      `<circle cx="5"  cy="6"  r="2.5" fill="none" stroke="currentColor" stroke-width="1.8"/>` +
      `<circle cx="19" cy="6"  r="2.5" fill="none" stroke="currentColor" stroke-width="1.8"/>` +
      `<circle cx="12" cy="18" r="2.5" fill="none" stroke="currentColor" stroke-width="1.8"/>` +
      `<line x1="6.5"  y1="7.5"  x2="11" y2="16" stroke="currentColor" stroke-width="1.6"/>` +
      `<line x1="17.5" y1="7.5"  x2="13" y2="16" stroke="currentColor" stroke-width="1.6"/>` +
      `<line x1="7.5"  y1="6"    x2="16.5" y2="6" stroke="currentColor" stroke-width="1.6"/>` +
    `</svg>`;
  }
