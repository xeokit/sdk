...
export class Toolbar extends FloatingPanelBase {
   ...
   * — `Toolbar.ts` no longer carries `_actionX` methods.
   */
   ...
   * Viewer / DemoHelper / button-state plumbing. The context is
        ...
        rows: [
          {
            ...
            run:   () => { this.demoHelper?.getSceneHealthPanel(); },
          },
          {
            label: "Data Health",
            svg:   DataHealthPanel.iconSvg(),
            run:   () => { this.demoHelper?.getDataHealthPanel(); },
          },
        ],
      },
      {
        ...
        rows: [
          {
            ...
            run:   () => { this.demoHelper?.openSceneStatsPanel(); },
          },
          {
            label: "Data Statistics",
            svg:   DataStatsPanel.iconSvg(),
            run:   () => { this.demoHelper?.openDataStatsPanel(); },
          },
        ],
      },
      {
        ...
        rows: [
          {
            ...
            run:   () => { this.demoHelper?.openBoundariesPanel(); },
          },
          {
            label: "GPU Tiles",
            svg:   TilesPanel.iconSvg(),
            run:   () => { this.demoHelper?.openTilesPanel(); },
          },
          {
            label: "GPU Memory",
            svg:   GPUMemoryPanel.iconSvg(),
            run:   () => { this.demoHelper?.getGPUMemoryPanel(); },
          },
          {
            label: "Events",
