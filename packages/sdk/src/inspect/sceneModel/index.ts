 ...
 * | Inspection                        | Codes                                                                                   |
 * | --------------------------------- | --------------------------------------------------------------------------------------- |
 * | {@link geometryDataIntegrity}        | `GEOMETRY_NO_POSITIONS`, `GEOMETRY_POSITIONS_LENGTH`, `GEOMETRY_NORMALS_LENGTH`, `GEOMETRY_UVS_LENGTH`, `GEOMETRY_COLORS_LENGTH`, `GEOMETRY_AABB_LENGTH`, `GEOMETRY_AABB_NONFINITE`, `GEOMETRY_AABB_INVERTED`, `GEOMETRY_INDICES_LENGTH`, `GEOMETRY_INDEX_OUT_OF_RANGE`, `GEOMETRY_EDGE_INDICES_LENGTH`, `GEOMETRY_EDGE_INDEX_OUT_OF_RANGE`, `GEOMETRY_SPLAT_SCALES_LENGTH`, `GEOMETRY_SPLAT_ROTATIONS_LENGTH` (errors) |
