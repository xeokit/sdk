...
/**
 * Creates wireframe vector text as a {@link model!scene.SceneGeometry | SceneGeometry}.
 *
 ...
 *
 * ## Returns:
 * Returns a {@link model!scene.SceneGeometry | SceneGeometry} object with the wireframe representation of the provided text, including the necessary positions, indices, and primitive type for rendering.
 *
 * ## Example:
 * ````javascript
