import {normalizeVec3, subVec3, type Vec3} from "../../../base/math/vector";
import {apply} from "../../../base/utils";
import type {GeometryArrays} from "./GeometryArrays";
import {TrianglesPrimitive} from "../../../base/constants";
import {SDKErrorType, type SDKResult} from "../../../base/core";

/**
 * Creates a torus-shaped {@link model!scene.SceneGeometry | SceneGeometry}.
 *
 ...
 *
 * ## Returns:
 * Returns a {@link model!scene.SceneGeometry | SceneGeometry} object containing the torus geometry with the necessary positions, indices, and optional normals and UV coordinates for rendering.
 *
 * ## Example:
 * ```javascript
 * const torusGeometryResult = buildTorus({
