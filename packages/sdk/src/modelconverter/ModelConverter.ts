import type { ModelExporter, ModelLoader } from "../io";
...
export class ModelConverter {
  ...
  convert(convertRequest: ModelConverterRequest): Promise<ModelConverterResult> {
    ...
    return new Promise((resolve, reject) => {
      ...
      for (const inputId in pipelineInputs) {
      ...
      for (const outputId in pipelineOutputs) {
  ...
  setConfigs(params: ModelConverterConfig): SDKError | void {
    for (const pipelineId in params.pipelines) {
