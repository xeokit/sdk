...
import type {PickParams as RendererPickParams} from "../viewer/PickParams";
import type {PickResult as RendererPickResult} from "../viewer/PickResult";
...
export class RendererPickStrategy implements PickStrategy {
  ...
  /**
   * @param renderer The renderer to drive. The strategy assumes the
