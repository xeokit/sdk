...
import {geometryArrayLengths} from "./inspections/geometryArrayLengths";
 ...
 * the website example Studio scene-model inspector inspections.
 *
 * Registration order:
 *
 ...
 *
 * ```ts
 * import {DEFAULT_INSPECTION_REGISTRY} from "@xeokit/sdk/quality/sceneModel";
 *
