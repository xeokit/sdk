...
export const similarGeometries: Inspection = {
  ...
  config: {
    enabled: {
      kind: "boolean",
      key: "checkSimilarGeometries",
      label: "Check similar geometries",
      description:
        "Compare triangle-indexed geometries by topology + " +
        "edge-length histogram and flag groups that share the " +
        "same pose-invariant shape, regardless of translation, " +
