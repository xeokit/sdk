import type {SceneGeometry, SceneMesh, SceneModel, SceneObject, SceneTransform} from "../../model/scene";
...
/**
 * Apply demo-grade optimisations to a {@link model!scene.SceneModel | SceneModel} in place.
 *
 * Passes run in order:
 *
 ...
 *      threshold. Each {@link model!scene.SceneMesh | SceneMesh} that referenced the
