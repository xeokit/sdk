 ...
 * and can be composed into a hierarchy of transforms. {@link SceneMesh} instances are typically
 * attached to transforms, allowing geometry to inherit transforms from parent nodes.
 *
 * ### Key concepts
 *
 * - Transforms form a tree (scene graph) within a {@link SceneModel}
 ...
 * Meshes are attached to transforms, and meshes can then be grouped into {@link SceneObject}s
 ...
 *
 * See {@link scene | @xeokit/sdk/scene} for more complete examples.
 */
