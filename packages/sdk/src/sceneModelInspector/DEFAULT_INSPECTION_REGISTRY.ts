 ...
 *  10. `largeGeometries`      (warning, opt-in via params)
 *  11. `geometryQuality`      (warnings, opt-in via params)
 *  12. `objectPlacement`      (warnings, opt-in via params)
 *  13. `textureDimensions`        (warnings, opt-in via params)
 *  14. `farFromOriginGeometries` (warning, opt-in via params)
 *
