...
import type {SceneTransform} from "../../model/scene";
import type {View} from "../../viewing/viewer";
import type {ViewController} from "../../viewing/viewController";
import type {AircraftForwardAxis} from "./AircraftMath";
 ...
 */
export interface AircraftControllerViewProxy extends Pick<View, "id" | "htmlElement" | "camera" | "objects" | "viewer"> {
