 ...
 *
 * This module wraps {@link viewing!vehicleNavigation.VehicleNavigationController}
 ...
 *
 * ```ts
 * import { AircraftController } from "@xeokit/sdk/simulation/aircraft";
 *
 ...
 * } from "@xeokit/sdk/simulation/aircraft";
 *
 * const config = {
 *   modelId: "aircraft",
 *   forwardAxis: "-Z",
