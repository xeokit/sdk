import type {Scene, SceneMesh, SceneObject} from "../../model/scene";
import {
  type AABB3,
  type AABB3Float,
  collapseAABB3,
...
/**
 * High-performance physics engine bound to a {@link model!scene.Scene | Scene}, backed by a
 ...
 * {@link spatial!collision.SceneCollisionIndex | SceneCollisionIndex} BVH is *not* invalidated by physics motion —
