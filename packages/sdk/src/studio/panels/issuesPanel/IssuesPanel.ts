/**
 * Floating, draggable Issues panel — collects every `onError`
 * and `onWarning` emission from the helper's `Scene`, `Data`,
 * `Viewer`, and `WebGLRenderer` event emitters, retains the
 * full history, and pops the panel into view the first time an
 * error fires so the user notices something went wrong without
 * having to watch the dev console.
 *
...
export type IssuesPanelLevel = "error" | "warning";

/**
 * One row in the panel's log.
 */
export interface IssuesPanelRecord {
...
const STYLE_TAG_ID = "xkt-issues-styles";
// Note: localStorage key updated below to "xkt-issues-panel"; existing
// users will see their previous Events-panel position reset once.
...
.xkt-issues-panel *, .xkt-issues-panel *::before, .xkt-issues-panel *::after {
  box-sizing: border-box;
}
.xkt-issues-panel[hidden] { display: none; }

.xkt-issues-panel .xkt-issues-header {
  display: flex;
  align-items: center;
  gap: 10px;
...
.xkt-issues-panel .xkt-issues-header.xkt-issues-dragging { cursor: grabbing; }
.xkt-issues-panel .xkt-issues-title {
  flex: 1;
  min-width: 0;
  margin: 0;
  font-size: 20px;
...
.xkt-issues-panel .xkt-issues-title-icon {
  flex-shrink: 0;
...
.xkt-issues-panel .xkt-issues-title-icon svg {
  width: 100%;
  height: 100%;
  display: block;
}
.xkt-issues-panel .xkt-issues-title-text {
  flex-shrink: 1;
  min-width: 0;
  white-space: nowrap;
  overflow: hidden;
...
.xkt-issues-panel .xkt-issues-title-stack {
  display: flex;
  flex-direction: column;
  gap: 3px;
  min-width: 0;
...
.xkt-issues-panel .xkt-issues-subtitle {
  font-size: 11px;
  font-weight: 400;
  color: #475569;
  line-height: 1.25;
}
.xkt-issues-panel .xkt-issues-counter {
  flex-shrink: 0;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
.xkt-issues-panel .xkt-issues-counter[data-count="0"] {
  background: #94a3b8;
}
.xkt-issues-panel .xkt-issues-clear,
.xkt-issues-panel .xkt-issues-copy-log,
.xkt-issues-panel .xkt-issues-open-log,
.xkt-issues-panel .xkt-issues-close {
  flex-shrink: 0;
  height: 28px;
  padding: 0;
  font: inherit;
...
.xkt-issues-panel .xkt-issues-close { width: 28px; font-size: 22px; }
.xkt-issues-panel .xkt-issues-clear:hover,
.xkt-issues-panel .xkt-issues-copy-log:hover,
.xkt-issues-panel .xkt-issues-open-log:hover,
.xkt-issues-panel .xkt-issues-close:hover {
  background: #f0f0f0;
  color: #222;
  border-color: #d0d0d0;
}
.xkt-issues-panel .xkt-issues-copy-log.xkt-issues-copy-log-done {
  color: #047857;
  background: rgba(4, 120, 87, 0.10);
  border-color: rgba(4, 120, 87, 0.32);
}
.xkt-issues-panel .xkt-issues-copy-log:disabled,
.xkt-issues-panel .xkt-issues-open-log:disabled {
  opacity: 0.4;
  cursor: not-allowed;
}
.xkt-issues-panel .xkt-issues-copy-log:disabled:hover,
.xkt-issues-panel .xkt-issues-open-log:disabled:hover {
  background: transparent;
  color: #777;
...
.xkt-issues-pill:hover { background: #7f1d1d; }
.xkt-issues-pill[hidden] { display: none; }
.xkt-issues-pill[data-count="0"] {
  background: #475569;
  border-color: #334155;
}
.xkt-issues-pill[data-count="0"]:hover { background: #334155; }
.xkt-issues-pill .xkt-issues-pill-count {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  min-width: 18px;
...
.xkt-issues-pill[data-count="0"] .xkt-issues-pill-count {
  color: #475569;
}

.xkt-issues-panel .xkt-issues-body {
  flex: 1 1 auto;
  overflow: auto;
  padding: 0;
}

.xkt-issues-panel .xkt-issues-section {
  border-bottom: 1px solid #ececec;
}
.xkt-issues-panel .xkt-issues-section:last-child {
  border-bottom: none;
}
...
.xkt-issues-panel .xkt-issues-section > summary::-webkit-details-marker { display: none; }
.xkt-issues-panel .xkt-issues-section > summary:hover {
  background: #f1f5f9;
}
.xkt-issues-panel .xkt-issues-section[open] > summary {
  border-bottom: 1px solid #ececec;
}
.xkt-issues-panel .xkt-issues-twisty {
  flex-shrink: 0;
  width: 12px;
  text-align: center;
  font-size: 10px;
...
.xkt-issues-panel .xkt-issues-section[open] .xkt-issues-twisty {
  transform: rotate(90deg);
}
.xkt-issues-panel .xkt-issues-section-name {
  font-size: 13px;
  letter-spacing: 0.2px;
}
.xkt-issues-panel .xkt-issues-section[data-source="scene"]    .xkt-issues-section-name { color: #1d4ed8; }
...
.xkt-issues-panel .xkt-issues-section-empty .xkt-issues-section-summary {
  font-style: italic;
  color: #94a3b8;
}
.xkt-issues-panel .xkt-issues-section-count {
  flex-shrink: 0;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
.xkt-issues-panel .xkt-issues-section-count[data-count="0"] {
  background: #cbd5e1;
  color: #475569;
}

.xkt-issues-panel .xkt-issues-list {
  list-style: none;
  margin: 0;
  padding: 0;
}
.xkt-issues-panel .xkt-issues-row {
  display: grid;
...
.xkt-issues-panel .xkt-issues-row:first-child { border-top: none; }
.xkt-issues-panel .xkt-issues-row[data-level="error"] {
  background: rgba(254, 226, 226, 0.45);
}
.xkt-issues-panel .xkt-issues-row[data-level="warning"] {
  background: rgba(254, 243, 199, 0.55);
}
.xkt-issues-panel .xkt-issues-time {
  font-variant-numeric: tabular-nums;
  color: #64748b;
  font-size: 11px;
  white-space: nowrap;
}
.xkt-issues-panel .xkt-issues-msg {
  min-width: 0;
...
.xkt-issues-panel .xkt-issues-type {
  display: inline-block;
  margin-top: 3px;
  padding: 1px 6px;
  font-size: 10px;
...
.xkt-issues-panel .xkt-issues-copy {
  align-self: start;
  width: 24px;
  height: 20px;
  padding: 0;
...
.xkt-issues-panel .xkt-issues-row:hover .xkt-issues-copy,
.xkt-issues-panel .xkt-issues-copy:focus-visible {
  opacity: 1;
}
.xkt-issues-panel .xkt-issues-copy:hover {
  background: rgba(148, 163, 184, 0.18);
  border-color: rgba(148, 163, 184, 0.32);
  color: #1f2937;
}
.xkt-issues-panel .xkt-issues-copy svg {
  width: 14px;
  height: 14px;
  display: block;
}
.xkt-issues-panel .xkt-issues-copy.xkt-issues-copy-done {
  opacity: 1;
  color: #047857;
  border-color: rgba(4, 120, 87, 0.32);
  background: rgba(4, 120, 87, 0.10);
...
export class IssuesPanel extends FloatingPanelBase {

  private static readonly _instances = new WeakMap<Viewer, IssuesPanel>();
  ...
  static getFor(viewer: Viewer): IssuesPanel | undefined {
    const inst = IssuesPanel._instances.get(viewer);
    return inst && !inst._destroyed ? inst : undefined;
  }

  static openFor(params: IssuesPanelParams): IssuesPanel {
    let inst = IssuesPanel._instances.get(params.viewer);
    if (inst && !inst._destroyed) {
      inst.show();
      return inst;
    }
    inst = new IssuesPanel(params);
    return inst;
  }
  ...
  private _sections!: Record<IssuesPanelSource, SectionView>;
   ...
   */
  private readonly _records: IssuesPanelRecord[] = [];
  ...
  constructor(params: IssuesPanelParams) {
    if (!params || !params.viewer) {
      throw new Error("IssuesPanel: viewer is required");
    }
    super({
      container:   params.container,
      storageKey:  params.storageKey || "xkt-issues-panel",
      classPrefix: "xkt-issues",
    });
    if (!params.scene)    throw new Error("IssuesPanel: scene is required");
    ...
    const prior = IssuesPanel._instances.get(params.viewer);
    if (prior && !prior._destroyed) prior.destroy();
    IssuesPanel._instances.set(params.viewer, this);
  ...
  get records(): readonly IssuesPanelRecord[] {
  ...
  destroy(): void {
    ...
    if (IssuesPanel._instances.get(this.viewer) === this) {
      IssuesPanel._instances.delete(this.viewer);
    }
    super.destroy();
  }
  ...
  private _attachListeners(): void {
    const subscribe = (events: any, source: IssuesPanelSource): void => {
      if (!events) return;
      for (const name of ["onError", "onWarning"] as const) {
        ...
        const level: IssuesPanelLevel = name === "onWarning" ? "warning" : "error";
   ...
   */
  private _logEvent(source: IssuesPanelSource, name: string, args: any): void {
    if (this._destroyed) return;
    const cap = IssuesPanel._LOG_CAPACITY;
  ...
  private _handleEvent(
    ...
    const record: IssuesPanelRecord = {
      timestamp: Date.now(),
      source,
      level,
      type,
  ...
  protected _buildDom(): void {
    this._pill = el("button", "xkt-issues-pill", {
      type: "button",
      title: "Reopen the Issues panel",
      hidden: true,
    }) as HTMLButtonElement;
    const pillIcon = el("span", "xkt-issues-pill-icon");
    pillIcon.innerHTML = IssuesPanel.iconSvg();
    pillIcon.style.width = "14px";
    pillIcon.style.height = "14px";
    pillIcon.style.display = "inline-flex";
    const pillLabel = document.createElement("span");
    pillLabel.textContent = "Issues";
    this._pillCountEl = el("span", "xkt-issues-pill-count");
    this._pillCountEl.textContent = "0";
    this._pill.append(pillIcon, pillLabel, this._pillCountEl);
    this._pill.dataset.count = "0";

    this._panel = el("div", "xkt-issues-panel");

    this._header = el("div", "xkt-issues-header");
    const title = el("h2", "xkt-issues-title");
    title.innerHTML =
      `<span class="xkt-issues-title-icon">${IssuesPanel.iconSvg()}</span>` +
      `<span class="xkt-issues-title-stack">` +
        `<span class="xkt-issues-title-text">Issues</span>` +
        `<span class="xkt-issues-subtitle">Errors and warnings this session.</span>` +
      `</span>`;

    this._counterEl = el("span", "xkt-issues-counter");
    this._counterEl.textContent = "0";
    this._counterEl.dataset.count = "0";
    this._counterEl.title = "Total events in log";

    this._copyLogBtn = el("button", "xkt-issues-copy-log", {
      type: "button",
    ...
    this._openLogBtn = el("button", "xkt-issues-open-log", {
      type: "button",
    ...
    this._clearBtn = el("button", "xkt-issues-clear", {
      type: "button",
    ...
    this._closeBtn = el("button", "xkt-issues-close", {
      type: "button",
    ...
    this._bodyEl = el("div", "xkt-issues-body");
    this._sections = {} as Record<IssuesPanelSource, SectionView>;
    for (const source of SECTION_ORDER) {
   ...
   * after that.
   */
  private _buildSection(source: IssuesPanelSource): SectionView {
    const details = document.createElement("details");
    details.className = "xkt-issues-section";
    details.dataset.source = source;
    details.classList.add("xkt-issues-section-empty");

    const summary = document.createElement("summary");

    const twisty = el("span", "xkt-issues-twisty");
    twisty.textContent = "▶";

    const name = el("span", "xkt-issues-section-name");
    name.textContent = SECTION_LABEL[source];

    const summaryEl = el("span", "xkt-issues-section-summary");

    const countEl = el("span", "xkt-issues-section-count");

    summary.append(twisty, name, summaryEl, countEl);
    details.appendChild(summary);

    const list = el("ul", "xkt-issues-list");
   ...
   */
  private _updateSectionMeta(source: IssuesPanelSource): void {
    const sec = this._sections[source];
    if (!sec) return;
    const n = sec.count;
    ...
    if (n === 0) {
      sec.details.classList.add("xkt-issues-section-empty");
      sec.summary.textContent = "no events";
    } else {
      sec.details.classList.remove("xkt-issues-section-empty");
  ...
  private _appendEntry(rec: IssuesPanelRecord): void {
    ...
    const copyBtn = el("button", "xkt-issues-copy", {
      type: "button",
   ...
   */
  public getLogPayload(): IssuesPanelLogPayload {
    ...
    return {
      meta: {
        ...
        capacity:        IssuesPanel._LOG_CAPACITY,
        skippedEvents:   Array.from(IssuesPanel._LOG_SKIP_EVENTS),
  ...
  private _openLogInNewTab(): void {
    ...
    try {
      ...
      console.warn("[IssuesPanel] open log failed (Blob):", e?.message ?? e);
      return;
    }
    ...
    if (!win) {
      ...
      // wasted.
      console.warn("[IssuesPanel] window.open returned null — likely blocked by the pop-up policy. URL:", url);
  ...
  private _copyLogToClipboard(): void {
    ...
    const ok = (): void => {
      ...
      this._copyLogBtn.classList.add("xkt-issues-copy-log-done");
      ...
      window.setTimeout(() => {
        this._copyLogBtn.classList.remove("xkt-issues-copy-log-done");
        this._copyLogBtn.textContent = restoreLabel || "Copy log";
      }, 1600);
    };
    const fail = (err: any): void => {
      console.warn("[IssuesPanel] copy log failed:", err?.message ?? err);
    };
  ...
  private _copyToClipboard(text: string, button: HTMLButtonElement): void {
    const ok = (): void => {
      button.classList.add("xkt-issues-copy-done");
      button.innerHTML = COPY_DONE_ICON_SVG;
      const restoreAt = window.setTimeout(() => {
        button.classList.remove("xkt-issues-copy-done");
    ...
    const fail = (err: any): void => {
      console.warn("[IssuesPanel] copy failed:", err?.message ?? err);
    };
...
export interface IssuesPanelLogPayload {
  meta: {
    sessionStart:    string;
    capturedAt:      string;
...
const SECTION_ORDER: readonly IssuesPanelSource[] = [
  "scene",
  "data",
  "viewer",
  "renderer",
