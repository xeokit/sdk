...
/**
 * Configures the analytical hemisphere ambient term for a {@link View}.
 *
 ...
 * across all three render modes so {@link constants!NavigationRender |
 * NavigationRender} and {@link constants!DetailedRender |
 * DetailedRender} pick up the same directional fill that
 * {@link constants!RealisticRender | RealisticRender} gets from full
