/**
 * Interface through which a {@link viewer!View | View} interacts with a {@link viewer!Renderer | Renderer}
 */
import {PickParams} from "./PickParams";
import {PickResult} from "./PickResult";

export interface ViewRendererProxy {

  /**
   * Toggles the rendering of transparent objects for the View.
   *
  ...
  /**
   * Enables or disables edge enhancement for the View.
   *
  ...
  /**
   * Enables or disables Screen Space Ambient Occlusion (SAO) for the View.
   *
  ...
  /**
   * Enables or disables Physically-Based Rendering (PBR) for the View.
   *
   ...
   */
   pick(pickParams: PickParams, pickResult?: PickResult): boolean;
