...
import {worldToRTCPos} from "../../../../base/math/rtc";
...
class PivotController {
  ...
  constructor(view: View, configs) {
    ...
    this._updateTask = new SDKTask({
      name: "ModelNavigationController->PivotController._updateTask",
   ...
   * at the viewpoint. The radius of the sphere is configured by the model navigation smart-pivot settings.
   *
   *
   * @param canvasPos
   */
