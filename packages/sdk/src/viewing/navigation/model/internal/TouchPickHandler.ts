import {createVec2Float32, distVec2, subVec3} from "../../../../base/math/vector";
...
export class TouchPickHandler {
  ...
  constructor(view: View, controllers: any, configs: any, states: any, updates: any) {
    ...
    htmlElement.addEventListener("touchstart", this.#canvasTouchStartHandler = (e) => {
      ...
      if (touches.length === 1 && changedTouches.length === 1) {
        ...
        states.longTouchTimeout = setTimeout(() => {
          modelNavigation.events.onRightClick.dispatch(modelNavigation, {
    ...
    htmlElement.addEventListener("touchend", this.#canvasTouchEndHandler = (e) => {
       ...
       */
      const pickedSurfaceSubs = modelNavigation.events.onPickedSurface.count > 0;
          ...
          if (lastTapTime > -1 && tapStartTime - lastTapTime < DBL_TAP_INTERVAL) {
            ...
            if (pickController.pickResult) {
              ...
              if (pickController.pickedSurface) {
                modelNavigation.events.onDoublePickedSurface.dispatch(modelNavigation, pickController.pickResult);
              }
              ...
              modelNavigation.events.onDoublePickedNothing.dispatch(modelNavigation, null);
            ...
            if (pickController.pickResult) {
              ...
              // Tap on empty space.
              modelNavigation.events.onPickedNothing.dispatch(modelNavigation, null);
            }
