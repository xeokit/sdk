...
/**
 * Controls the viewpoint and projection for a {@link viewing!viewer.View | View}.
 *
 ...
 *
 * Let's create a {@link Viewer | Viewer} with a single {@link viewing!viewer.View | View}, from which we'll get a Camera:
 *
 * ````javascript
...
class Camera {
   ...
   *
   * The Camera uses this while {@link Camera.projectionType} equals {@link base!constants.OrthoProjectionType | OrthoProjectionType}.
   */
   ...
   *
   * The Camera uses this while {@link Camera.projectionType} equals {@link base!constants.FrustumProjectionType | FrustumProjectionType}.
   */
   ...
   *
   * The Camera uses this while {@link Camera.projectionType} equals {@link base!constants.CustomProjectionType | CustomProjectionType}.
   */
