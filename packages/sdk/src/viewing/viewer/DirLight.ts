...
class DirLight {
  ...
  /**
   ID of this DirLight, unique within the {@link viewing!viewer.View | View}.
   */
   ...
   * @param [options.id] Optional ID, unique among all components in the parent {@link model!scene.Scene | Scene}, generated automatically when omitted.
