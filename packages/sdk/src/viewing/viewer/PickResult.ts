...
import {SceneMesh, SceneObject} from "../../model/scene";
import {View} from "./View";
import {createVec2Int32, createVec2Float64, createVec3Float64, type Vec2, type Vec3} from "../../base/math/vector";
...
class PickResult {
  ...
  /**
   * The picked {@link viewing!viewer.View | View}.
   */
  ...
  /**
   * The picked {@link model!scene.SceneObject | SceneObject}.
   */
  ...
  /**
   * The picked {@link model!scene.SceneMesh | SceneMesh}.
   */
  ...
  /**
   * The picked {@link viewing!viewer.ViewObject | ViewObject}.
   */
