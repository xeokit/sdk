...
export abstract class DrawTechnique {
  ...
  private _initProgram(): SDKResult<any> {
    ...
    this._samplers = {
      ...
      viewTileCameraMatrices: program.getSampler("uTileViewMatrices"),
      vertexPositions: program.getSampler("uPositions"),
  ...
  protected vsCommonDefines() {
    this._vertSrcBuf.push(
      ...
      "uniform highp usampler2D uPrimMeshIndexTable;   // DTXPointerArray",
      ...
      "uniform highp sampler2D  uMeshMatrixTable;       // DTXMatrixArray",
      "uniform highp usampler2D uMeshAttribTable;        // DTXMeshAttribTable",
      "uniform highp usampler2D uViewMeshAttribTable;    // DTXViewMeshAttribTable",
      "uniform highp usampler2D uGeometryAttribTable;    // DTXGeometryAttribTable",
      "uniform highp sampler2D  uGeometryQuantRangeTable;// DTXQuantRanges",
