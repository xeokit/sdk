 ...
 */
export class DTXMeshAttribTable extends DataTexture {
  ...
  getAllocatedBytes(): number {
    return this.maxItems * DTXMeshAttribTable.itemSizeInBytes;
  }
  ...
  getUsedBytes() {
    return this._getNumItems() * DTXMeshAttribTable.itemSizeInBytes;
  }
  ...
  allocate(): SDKResult<void> {
    ...
    return {
      ...
      error: `[DTXMeshAttribTable]: Exception during buffer allocation: ${e}`
    };
    }
  ...
  _allocateTexture(): SDKResult<void> {
    ...
    if (!tex) {
      return {
        ok: false,
        type: SDKErrorType.InitializationFailed,
        error: "[DTXMeshAttribTable]: Failed to create texture"
      };
    }
    try {
      ...
      return {
        ok: false,
        type: SDKErrorType.InitializationFailed,
        error: `[DTXMeshAttribTable]: Exception during texture allocation: ${e}`
      };
    }
    this.texture = tex;
    return {
