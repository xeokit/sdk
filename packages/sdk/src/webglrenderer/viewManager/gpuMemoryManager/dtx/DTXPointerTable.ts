...
//  */
// export class DTXPointerTable extends PortionDataTexture {
//
...
//   }
//
//   getItemAtTexel(x: number, y: number): { value: number } {
//     const addr = DTXPointerTable.encodeAddress(x, y, this.width);
//     if (addr < 0 || addr >= this.maxItems) {
//       throw new RangeError(`DTXPointerTable.getItemAtTexel: address (${x},${y}) out of range`);
//     }
//     const value = this.buffer[addr] >>> 0;
//     return {value};
//   }
//
//   getItem(index: number): { value: number } {
//     this._assertIndex(index);
//     return {value:this.buffer[index] >>> 0};
//   }
//
//   // ---------------- GPU upload ----------------
//
...
//       throw new RangeError(`DTXPointerTable: index ${i} out of range [0, ${this.maxItems})`);
//     }
//   }
//
