...
//         eachTextureDataPortion: new Uint32Array(numTextures), // For each texture, an tileIndex to its first element in textureData
...
//         eachGeometryPositionsPortion: new Uint32Array(numGeometries), // For each geometry, an tileIndex to its first element in xktData.positions. Every primitive type has positions.
//         eachGeometryNormalsPortion: new Uint32Array(numGeometries), // For each geometry, an tileIndex to its first element in xktData.normals. If the next geometry has the same tileIndex, then this geometry has no normals.
//         eachGeometryColorsPortion: new Uint32Array(numGeometries), // For each geometry, an tileIndex to its first element in xktData.colors. If the next geometry has the same tileIndex, then this geometry has no colors.
//         eachGeometryUVsPortion: new Uint32Array(numGeometries), // For each geometry, an tileIndex to its first element in xktData.uvs. If the next geometry has the same tileIndex, then this geometry has no UVs.
//         eachGeometryIndicesPortion: new Uint32Array(numGeometries), // For each geometry, an tileIndex to its first element in xktData.indices. If the next geometry has the same tileIndex, then this geometry has no indices.
...
//         eachTileEntitiesPortion: new Uint32Array(numTiles) // For each tile, the tileIndex of the first element of eachEntityId, eachEntityMeshesPortion and eachEntityMatricesPortion used by the tile
//     };
//
