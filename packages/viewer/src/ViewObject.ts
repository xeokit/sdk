...
export class ViewObject {
   ...
   */
  public readonly viewerObject: ViewerObject;
  ...
  set visible(visible: boolean) {
    ...
    this.viewerObject.setVisible(this.layer.view.viewIndex, visible);
  ...
  set xrayed(xrayed: boolean) {
    ...
    this.viewerObject.setXRayed(this.layer.view.viewIndex, xrayed);
  ...
  set edges(edges: boolean) {
    ...
    this.viewerObject.setEdges(this.layer.view.viewIndex, edges);
    this.layer.redraw();
  }
  ...
  set highlighted(highlighted: boolean) {
    ...
    this.viewerObject.setHighlighted(
  ...
  set selected(selected: boolean) {
    ...
    this.viewerObject.setSelected(this.layer.view.viewIndex, selected);
