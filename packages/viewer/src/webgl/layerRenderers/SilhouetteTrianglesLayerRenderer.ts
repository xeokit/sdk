    ...
    buildVertexShader(): string {
        return `${this.vertHeader}   
                ...
                void main(void) {
                    ...
                    mat4 modelMatrix = mat4 (texelFetch (sceneModelMatrices, ivec2(0, 0), 0), texelFetch (sceneModelMatrices, ivec2(1, 0), 0), texelFetch (sceneModelMatrices, ivec2(2, 0), 0), texelFetch (sceneModelMatrices, ivec2(3, 0), 0));
