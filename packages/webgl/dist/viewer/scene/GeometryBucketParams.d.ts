import type { IntArrayParam } from "../math/math";
/**
...
export interface GeometryBucketParams {
     ...
     *
     * Internally, the WebViewer uses {@link GeometryCompressedParams.positionsDecompressMatrix} to decompress (dequantize)
     ...
     *
     * Internally, the WebViewer de-quantizes these with {@link GeometryCompressedParams.uvsDecompressMatrix}.
     */
