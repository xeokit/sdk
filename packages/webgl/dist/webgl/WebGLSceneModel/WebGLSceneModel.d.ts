import { Component, Scene, View, SceneModel, math, GeometryParams, MeshParams, SceneObjectParams, TextureParams, TextureSetParams, SceneObject, Transform, GeometryCompressedParams, EventEmitter } from "../../viewer/index";
...
export declare class WebGLSceneModel extends Component implements SceneModel {
    #private;
