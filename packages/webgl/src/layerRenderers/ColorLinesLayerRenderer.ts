...
export class ColorLinesLayerRenderer extends LayerRenderer {
    ...
    buildVertexShader(): string {
        return `${this.vertHeader}   
                ...
                void main(void) {
                    ...
                    mat4 worldMatrix = mat4 (texelFetch (viewerModelMatrices, ivec2(0, 0), 0), texelFetch (viewerModelMatrices, ivec2(1, 0), 0), texelFetch (viewerModelMatrices, ivec2(2, 0), 0), texelFetch (viewerModelMatrices, ivec2(3, 0), 0));
