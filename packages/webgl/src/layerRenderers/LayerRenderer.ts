...
export abstract class LayerRenderer {
    ...
    draw(layer: Layer) {
        ...
        if (uniforms.worldMatrix) {
            gl.uniformMatrix4fv(uniforms.worldMatrix, false, <Float32Array | GLfloat[]>layer.viewerModel.worldMatrix);
        }
        ...
        //     const drawFlags = viewerModel.drawFlags;
    ...
    protected get vertDataTextureDefs(): string {
        return `uniform mediump sampler2D eachMeshMatrices;
                ...
                uniform highp sampler2D viewerModelMatrices;`;
    }
