...
export class TrianglesSilhouetteLayerRenderer extends TrianglesLayerRenderer {
    ...
    buildVertexShader(): string {
        return `${this.vertHeader}   
                ...
                void main(void) {
                    ...
                    mat4 modelMatrix = mat4 (texelFetch (sceneModelRendererMatrices, ivec2(0, 0), 0), texelFetch (sceneModelRendererMatrices, ivec2(1, 0), 0), texelFetch (sceneModelRendererMatrices, ivec2(2, 0), 0), texelFetch (sceneModelRendererMatrices, ivec2(3, 0), 0));
