 ...
 * @private
 */
export abstract class VBOBatchingRenderer {
    ...
    render(vboBatchingLayer: VBOBatchingLayer, renderPass: number): void {
        this.bind();
        ...
        this.draw(vboBatchingLayer, renderPass);
    }

    abstract draw(layer: VBOBatchingLayer, renderPass: number);
