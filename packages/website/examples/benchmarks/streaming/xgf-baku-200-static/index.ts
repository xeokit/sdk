...
const STREAM_STALL_STORAGE_KEY = "xeokit.benchmarks/streaming/xgf-baku-200-static.stallStreamingWhileMoving";
const DEFAULT_STALL_STREAMING_WHILE_MOVING = true;
const VIEWPOINT_MOTION_STORAGE_KEY = "xeokit.benchmarks/streaming/xgf-baku-200-static.viewpointMotion";
