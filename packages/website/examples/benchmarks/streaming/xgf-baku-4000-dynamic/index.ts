...
const STREAM_CACHE_KEY = "baku-4000-dynamic-cousage-1024-20260730";
const MODEL_ID = "BakuStadium_xgfstream_4000";
const THUMBNAIL_BASE_URL = "bcf_thumbnails/";
const GLOBAL_EXAMPLE_NAME = "bakuStreaming4000DynamicExample";
const READY_MARKER_ID = "XGFStreamingBaku4000DynamicReady";
...
const STREAM_STALL_STORAGE_KEY = "xeokit.benchmarks/streaming/xgf-baku-4000-dynamic.stallStreamingWhileMoving";
const DEFAULT_STALL_STREAMING_WHILE_MOVING = true;
const VIEWPOINT_MOTION_STORAGE_KEY = "xeokit.benchmarks/streaming/xgf-baku-4000-dynamic.viewpointMotion";
...
sdkProgress.setPhase("Booting Baku 4000 dynamic stream");
