...
studio
    ...
    .then(() => {
        ...
        // Studio. The Scene manages renderable content, while the
        // Data subsystem manages semantic model structure and metadata.
        const { view, scene, data } = studio;
        ...
        // relationships, and property sets. Tagging the model with a
        // schema id matches the per-entity `schema: "MySchema"` stamp
        // below — schema-aware tooling (the dataModelInspector's
        // schemaTagging check, etc.) reads it from either side.
