...
studio.init().then(async () => {
    ...
    pushGeom("box", mustBuild(xeokit.model.procgen.buildGeometry.buildBox({ xSize: 1, ySize: 1, zSize: 1 })));
    ...
    pushGeom("dome", mustBuild(xeokit.model.procgen.buildGeometry.buildSphere({
        radius: 0.5,
        widthSegments: 24,
        heightSegments: 16
    })));
