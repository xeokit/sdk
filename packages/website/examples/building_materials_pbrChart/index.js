...
studio.init().then(() => {
  ...
  const hdrPixels = xeokit.model.procgen.paintEnvironments.paintSunSkyHDR(512, 256, { sunDirection: sunWorld });
  const hdrBuf = xeokit.model.procgen.paintEnvironments.encodeRadianceHDR(hdrPixels, 512, 256);
