...
new xeokit.base.core.EventsLogger(data.events, { prefix: "[Data     ]" });
...
new xeokit.base.core.SDKTask({
  ...
  task: () => {
    ...
    myMesh.matrix = xeokit.base.math.matrix.rotationMat4v(r, [0, 1, 0]);
    myMesh2.matrix = xeokit.base.math.matrix.rotationMat4v(r, [1, 0, 0]);
  }
});