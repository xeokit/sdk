...
studio.init().then(() => {
  ...
  const boxResult = xeokit.model.generation.buildGeometry.buildBox({
    xSize: 1,
    ySize: 1,
    zSize: 1
  });
  ...
  const boxLinesResult = xeokit.model.generation.buildGeometry.buildBoxLines({
    xSize: 1,
    ySize: 1,
    zSize: 1
  });
  ...
  const torusResult = xeokit.model.generation.buildGeometry.buildTorus({
    center: [0, 0, 0],
    radius: 1.50,
    tube: 0.50,
    radialSegments: 32,
  ...
  const cylinderResult = xeokit.model.generation.buildGeometry.buildCylinder({
    center: [0, 0, 0],
    radiusTop: 1.00,
    radiusBottom: 2.00,
    height: 2.50,
  ...
  const gridResult = xeokit.model.generation.buildGeometry.buildGrid({
    size: 10,
    divisions: 10
  });
  ...
  const textResult = xeokit.model.generation.buildGeometry.buildVectorText({
