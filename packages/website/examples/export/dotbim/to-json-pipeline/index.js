...
studio.init().then(() => {
  ...
  const modelConverter = new xeokit.conversion.pipeline.ModelConverter({
    loaders: {
          ...
          modelConverter.convert({
            ...
            sceneModelParamsLoader.load({
              ...
              dataModelParamsLoader.load({
                ...
                const modelConverterStatsReport = xeokit.conversion.pipeline.reporters.stats.createStatsReport(result);

           //     studio.showModelConverterStatsReport(modelConverterStatsReport);
