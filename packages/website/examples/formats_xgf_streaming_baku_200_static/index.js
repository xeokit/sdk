...
const STREAM_STALL_STORAGE_KEY = "xeokit.formats_xgf_streaming_baku_static.stallStreamingWhileMoving";
const DEFAULT_STALL_STREAMING_WHILE_MOVING = true;
const VIEWPOINT_MOTION_STORAGE_KEY = "xeokit.formats_xgf_streaming_baku_static.viewpointMotion";
