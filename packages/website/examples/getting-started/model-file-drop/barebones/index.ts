...
import {WEBGPU_RENDER_CONFIG_PROFILES} from "@xeokit/sdk/viewing/renderers/webGPU";
...
const REQUESTED_RENDERER = normalizeRenderer(URL_PARAMS.get("renderer") || URL_PARAMS.get("backend") || "webgpu");
...
function getLoaderInfo(fileName) {
  ...
  const registry = {
    "xgf": {label: "XGF", Loader: XGFLoader, fileDataType: "arraybuffer", withDataModel: true},
    "xkt": {label: "XKT", Loader: XKTLoader, fileDataType: "arraybuffer", withDataModel: true},
    "glb": {label: "glTF", Loader: GLTFLoader, fileDataType: "arraybuffer"},
    "gltf": {label: "glTF", Loader: GLTFLoader, fileDataType: "arraybuffer"},
    "ifc": {label: "IFC", Loader: IFCLoader, fileDataType: "arraybuffer", withDataModel: true},
    "bim": {label: "dotBIM", Loader: DotBIMLoader, fileDataType: "json"},
    "las": {label: "LAS", Loader: LASLoader, fileDataType: "arraybuffer"},
    "laz": {label: "LAZ", Loader: LASLoader, fileDataType: "arraybuffer"},
    "ply": {label: "PLY", Loader: PLYLoader, fileDataType: "text"},
    "fbx": {label: "FBX", Loader: FBXLoader, fileDataType: "arraybuffer"},
    "usdz": {label: "USDZ", Loader: USDZLoader, fileDataType: "arraybuffer"},
    "cityjson": {label: "CityJSON", Loader: CityJSONLoader, fileDataType: "json"},
    "json": {label: "CityJSON", Loader: CityJSONLoader, fileDataType: "json"},
    "dxf": {label: "DXF", Loader: DXFLoader, fileDataType: "text"},
    "dwg": {label: "DWG", Loader: DWGLoader, fileDataType: "arraybuffer"},
    "3dxml": {label: "3DXML", Loader: ThreeDXMLLoader, fileDataType: "arraybuffer"},
    "splat": {label: "Gaussian splat", Loader: GaussianSplatLoader, fileDataType: "arraybuffer"}
  };
...
function reportError(message) {
  ...
  status.textContent = message;
  console.error("[getting-started/model-file-drop/barebones]", message);
}
