// Loads the bundled HousePlan model from XGF and exposes the Rendering
// panel — same shape and wiring as the materials-chart, Cityscape and
// Duplex demos. Effect parameters are not overridden; the SDK
// constructor defaults stand and the panel HTML mirrors them.
...
studio.init().then(async () => {
  ...
  // Default Z-up scene: camera up axis is +Z, so the floor sits in the
  // XY plane and the building extends upward along Z. Eye / look match
