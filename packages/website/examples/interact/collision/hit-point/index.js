...
studio.init().then(() => {
  ...
  // anything that *did* try to GPU-pick (e.g. ModelNavigationController internals)
  ...
  buildAndRegister("box",
    () => xeokit.model.generation.buildGeometry.buildBox({ xSize: 1, ySize: 1, zSize: 1 }));

  buildAndRegister("cyl", () => xeokit.model.generation.buildGeometry.buildCylinder({
    radiusTop: 1, radiusBottom: 1, height: 1,
    radialSegments: 28, heightSegments: 1
  }));

  buildAndRegister("tcyl", () => xeokit.model.generation.buildGeometry.buildCylinder({
    radiusTop: 0.45, radiusBottom: 1, height: 1,
    radialSegments: 28, heightSegments: 1
  }));

  buildAndRegister("sph", () => xeokit.model.generation.buildGeometry.buildSphere({
