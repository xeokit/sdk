window.PROCEDURAL_CITY_STREAM_CONFIG = {
  ...
  "viewId": "cityFlightSimView",
  "streamLabel": "City flight sim",
  "renderer": "webgl",
  ...
  "fastVisuals": {
    ...
    "sky": {
      "skyColor": [0.62, 0.78, 0.94],
      "horizonColor": [0.92, 0.96, 1.0],
      "groundColor": [0.64, 0.68, 0.62],
      "blend": 0.22,
      "intensity": 1.08
    },
    "hemispheric": {
      "enabled": true,
      "intensity": 0.28,
      "skyColor": [0.78, 0.87, 0.98],
      "groundColor": [0.48, 0.50, 0.45],
      "worldUp": [0, 0, 1]
    },
    "ambientLight": {
      "color": [1, 1, 1],
