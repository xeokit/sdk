...
const GLOBAL_EXAMPLE_NAME = "bakuStreamingStaticExample";
const READY_MARKER_ID = "XGFStreamingBakuStaticReady";
...
const STREAM_STALL_STORAGE_KEY = "xeokit.streaming.xgf.baku200Static.stallStreamingWhileMoving";
const DEFAULT_STALL_STREAMING_WHILE_MOVING = true;
const VIEWPOINT_MOTION_STORAGE_KEY = "xeokit.streaming.xgf.baku200Static.viewpointMotion";
...
sdkProgress.setPhase("Booting Baku static stream");
...
studio.init().then(async () => {
  ...
  try {
    ...
    const renderInspector = getOptionalRenderInspector(studio.renderer);
    if (renderInspector) {
