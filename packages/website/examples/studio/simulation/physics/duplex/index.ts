...
//
// This studio-gallery copy uses the same standalone SDK flow as the main
// example: direct Scene/View/renderer construction, explicit model coordinate
// systems, and Rapier passed into the shared physics helper.
...
main().catch((error) => failExample("studio/simulation/physics/duplex", error));
...
async function main() {
  ...
  physics.setBody("slab", {type: "fixed", shape: "cuboid"});
