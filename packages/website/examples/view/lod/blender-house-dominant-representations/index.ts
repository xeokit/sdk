...
async function main() {
  // Use the coordinate-system metadata that was used when this XGF was
  // exported. The basis maps the source model's Y-up coordinates into the
  // Scene's Z-up world before LOD projected-size decisions are made.
