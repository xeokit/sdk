...
function applyRuntimeConfig(config) {
  ...
  if (runtime.webglView && runtime.webgpuView && runtime.AmbientLight && runtime.DirLight) {
    ...
    runtime.webglView.needsRender();
    runtime.webgpuView.needsRender();
  }
...
function getHDRBuffer() {
  if (!cachedHDRBuffer) {
    ...
    const hdrPixels = paint.paintStudioHDR(512, 256);
    cachedHDRBuffer = paint.encodeRadianceHDR(hdrPixels, 512, 256);
  }
