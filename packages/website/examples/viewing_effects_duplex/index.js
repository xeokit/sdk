// Full effects-stack tour on the Duplex IFC model.
//
// The Rendering panel matches the materials-chart and Cityscape demos:
// pick a render-mode preset, then refine individual effects. Effect
...
studio.init().then(() => {
  ...
  fetch("../../models/Duplex/ifc/model.ifc")
    ...
    .then(fileData => ifcLoader.load({ fileData, sceneModel, dataModel }))
    .then(() => {
