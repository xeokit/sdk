...
// Create a Studio, but *don’t* let it auto-create the default View.
...
// Studio.init() creates the core pieces (Viewer, Scene, Data, etc).
...
studio.init().then(() => {
  ...
  const { viewer, scene, data } = studio;
  ...
  // view1.camera.projectionType = xeokit.base.constants.PerspectiveProjectionType;
  ...
  // view2.camera.projectionType = xeokit.base.constants.OrthoProjectionType;
  ...
  // Uncomment if you want to be explicit:
  // view3.camera.projectionType = xeokit.base.constants.PerspectiveProjectionType;
  ...
  new xeokit.viewing.viewController.ViewController(view1, {});
  new xeokit.viewing.viewController.ViewController(view2, {});
  new xeokit.viewing.viewController.ViewController(view3, {});
  ...
  //   .then(() => {
      ...
      fetch(`../../models/AlignedPointCloud/laz/model.laz`)
        ...
        .then(() => {
          ...
          // Signal to Studio that everything is loaded and ready (often hides spinners, etc).
          studio.finished();
        });
