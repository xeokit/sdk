...
// Create a Studio without the default View.
...
studio.init().then(() => {
  ...
  const {viewer, scene, data, renderer} = studio;
      ...
      [
        {
          getTitle: (context) => {
            ...
            const isOrtho = camera.projectionType === xeokit.base.constants.OrthoProjectionType;
            return isOrtho ? "Perspective View" : "Orthographic View";
          },
          doAction: function (context) {
            const camera = context.view.camera;
            const isOrtho = camera.projectionType === xeokit.base.constants.OrthoProjectionType;
            camera.projectionType = isOrtho ? xeokit.base.constants.PerspectiveProjectionType : xeokit.base.constants.OrthoProjectionType;
          }
        }
      ]
    ]
