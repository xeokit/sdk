...
const SOLAR_RAMP = [
    // Keep unheated faces readable. The original near-black cold end
    // made the table disappear whenever the synthetic sun moved away.
    { position: 0.00, color: [0.16, 0.32, 0.78] },   // cool shadow
    { position: 0.20, color: [0.28, 0.34, 0.70] },   // dim blue-violet
    { position: 0.45, color: [0.76, 0.36, 0.24] },   // dawn / dusk
...
main().catch((error) => failExample("workflows/heatmaps/solar-table", error));
