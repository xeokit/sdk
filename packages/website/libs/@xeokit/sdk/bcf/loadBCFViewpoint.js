 ...
 */
export function loadBCFViewpoint(params) {
    ...
    */
    ...
    if (bcfViewpoint.components) {
        if (bcfViewpoint.components.visibility) {
            if (!bcfViewpoint.components.visibility.default_visibility) {
                ...
                if (bcfViewpoint.components.visibility.exceptions) {
                    bcfViewpoint.components.visibility.exceptions.forEach(component => withBCFComponent(data, view, params, component, (viewObject) => {
        ...
        if (bcfViewpoint.components.selection) {
            view.setObjectsSelected(view.selectedObjectIds, false);
            bcfViewpoint.components.selection.forEach(component => withBCFComponent(data, view, params, component, (viewObject) => {
                if (filterViewObject(viewObject)) {
        ...
        if (bcfViewpoint.components.translucency) {
            view.setObjectsXRayed(view.xrayedObjectIds, false);
            bcfViewpoint.components.translucency.forEach(component => withBCFComponent(data, view, params, component, (viewObject) => {
                if (filterViewObject(viewObject)) {
                    viewObject.xrayed = true;
                }
            }));
        ...
        if (bcfViewpoint.components.coloring) {
            bcfViewpoint.components.coloring.forEach(coloring => {
                ...
                coloring.components.map(component => withBCFComponent(data, view, params, component, (viewObject) => {
...
function withBCFComponent(data, view, params, component, callback) {
...
function globalizeObjectId(modelId, objectId) {
...
//# sourceMappingURL=loadBCFViewpoint.js.map
