...
import { KEY_A, KEY_ADD, KEY_D, KEY_DOWN_ARROW, KEY_E, KEY_LEFT_ARROW, KEY_NUM_1, KEY_NUM_2, KEY_NUM_3, KEY_NUM_4, KEY_NUM_5, KEY_NUM_6, KEY_Q, KEY_RIGHT_ARROW, KEY_S, KEY_SUBTRACT, KEY_UP_ARROW, KEY_W, KEY_X, KEY_Z } from "./keycodes";
 ...
 * double-tap (ie. "double-pick") an object to fit it to view. This will cause the {@link Camera}
 ...
 * or double-tap an object (ie. "double-picking") to fit it in view. This will cause the {@link Camera} to fly to
...
export class CameraControl extends Component {
    ...
    constructor(view, cfg = {}) {
        ...
        this.onHover = new EventEmitter(new EventDispatcher());
        this.onHoverOff = new EventEmitter(new EventDispatcher());
        this.onHoverEnter = new EventEmitter(new EventDispatcher());
        this.onHoverOut = new EventEmitter(new EventDispatcher());
        this.onRightClick = new EventEmitter(new EventDispatcher());
        this.onHoverSurface = new EventEmitter(new EventDispatcher());
        this.onPicked = new EventEmitter(new EventDispatcher());
        this.onPickedSurface = new EventEmitter(new EventDispatcher());
        this.onPickedNothing = new EventEmitter(new EventDispatcher());
        this.onDoublePicked = new EventEmitter(new EventDispatcher());
        this.onDoublePickedSurface = new EventEmitter(new EventDispatcher());
        this.onDoublePickedNothing = new EventEmitter(new EventDispatcher());
        this.onHoverSnapOrSurfaceOff = new EventEmitter(new EventDispatcher());
        this.onHoverSnapOrSurface = new EventEmitter(new EventDispatcher());
        this.onRayMove = new EventEmitter(new EventDispatcher());
    ...
    /**
     * Sets whether double-picking an object causes the {@link Camera} to fly to its boundary.
     *
     * Default is ````false````.
     *
    ...
    /**
     * Gets whether double-picking an object causes the {@link Camera} to fly to its boundary.
     *
     * Default is ````false````.
     *
