 ...
 *
 * Various model file formats can be imported into DataModels using methods such as {@link gltf!GLTFLoader | GLTFLoader}, {@link las!loadLAS | loadLAS},
 * {@link cityjson!loadCityJSON | loadCityJSON}, and {@link xgf!XGFLoader | XGFLoader},
 * while DataModels can be exported to the native [XGF](https://xeokit.github.io/sdk/docs/pages/GLOSSARY.html#xgf) format using {@link xgf!XKFWriter | XKFWriter}.
 *
 ...
 * DataObjects can be queried using the {@link data!searchObjects | searchObjects} method, and
 ...
 * as traversals of the DataObjects with {@link data!searchObjects | searchObjects } must be
 ...
 * ## Reading DataObjects
 *
 * With our {@link data!DataModel | DataModel} built, we'll now use the {@link data!searchObjects | searchObjects} method to
 ...
 * });
 *
 * dataModel2.fromJSON(dataModelParams);
 *
 * dataModel2.build();
 * ````
 *
