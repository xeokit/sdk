 ...
 */
export function createPrimsKdTree3(primitiveType, positions, indices) {
...
function insertPoint(positions, a, kdTree) {
...
function insertLine(positions, a, b, kdTree) {
    const ax = positions[(a * 3)];
    const ay = positions[(a * 3) + 1];
    const az = positions[(a * 3) + 2];
...
function insertTriangle(positions, a, b, c, kdTree) {
    const ax = positions[(a * 3)];
    const ay = positions[(a * 3) + 1];
    const az = positions[(a * 3) + 2];
    const bx = positions[(b * 3)];
...
//# sourceMappingURL=createPrimsKdTree3.js.map