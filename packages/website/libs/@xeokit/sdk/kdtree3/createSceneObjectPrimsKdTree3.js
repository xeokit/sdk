 ...
 * @param sceneObjects
 */
export function createSceneObjectPrimsKdTree3(sceneObjects) {
    const tempAABBInt16 = new Int16Array(6);
    function insertPoint(sceneObject, sceneGeometry, positions, a, kdTree) {
    ...
    function insertLine(sceneObject, sceneGeometry, positions, a, b, kdTree) {
        const ax = positions[(a * 3)];
        const ay = positions[(a * 3) + 1];
        const az = positions[(a * 3) + 2];
    ...
    function insertTriangle(sceneObject, sceneGeometry, positions, a, b, c, kdTree) {
        const ax = positions[(a * 3)];
        const ay = positions[(a * 3) + 1];
        const az = positions[(a * 3) + 2];
        const bx = positions[(b * 3)];
...
//# sourceMappingURL=createSceneObjectPrimsKdTree3.js.map