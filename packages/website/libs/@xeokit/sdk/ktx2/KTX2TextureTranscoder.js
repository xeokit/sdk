import { LinearEncoding, LinearFilter, LinearMipmapLinearFilter, RGB_ETC1_Format, RGB_ETC2_Format, RGB_PVRTC_4BPPV1_Format, RGB_S3TC_DXT1_Format, RGBA_ASTC_4x4_Format, RGBA_BPTC_Format, RGBA_ETC2_EAC_Format, RGBA_PVRTC_4BPPV1_Format, RGBA_S3TC_DXT5_Format, RGBAFormat, sRGBEncoding } from "../constants";
 ...
 */
export class KTX2TextureTranscoder {
    #transcoderPath;
    #transcoderBinary;
    #transcoderPending;
    #workerPool;
...
const BasisWorker = function () {
    ...
    // significant _gpuMemoryManager cost) compared to ETC1/2, BC1/3, and PVRTC. The transcoder currently
...
//# sourceMappingURL=KTX2TextureTranscoder.js.map
