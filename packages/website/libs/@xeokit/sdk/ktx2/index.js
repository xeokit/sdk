 ...
 * {@link ktx2!KTX2TextureTranscoder | KTX2TextureTranscoder}. Then create a {@link scene!SceneModel | SceneModel} within the Viewer, and use {@link XGFReader} to
 ...
 *     .then(response => {
 *          if (response.ok) {
 *              XGFLoader(response.arrayBuffer(), sceneModel);
 *              sceneModel.build();
 *          }
 *     });
 * ````
