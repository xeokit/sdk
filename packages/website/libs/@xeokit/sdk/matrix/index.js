 ...
 */
export function dotVec3(u, v) {
    return (u[0] * v[0] + u[1] * v[1] + u[2] * v[2]);
}
/**
 * Returns a new, uninitialized two-element vector.
 */
export function createVec2(values) {
    // @ts-ignore
 ...
 */
export function createVec3(values) {
    // @ts-ignore
 ...
 */
export function createVec4(values) {
    // @ts-ignore
 ...
 */
export function negateVec3(v, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = -v[0];
 ...
 */
export function negateVec4(v, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = -v[0];
 ...
 */
export function addVec4(u, v, dest) {
    if (!dest) {
        dest = u;
    }
    dest[0] = u[0] + v[0];
 ...
 */
export function addVec4Scalar(v, s, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = v[0] + s;
 ...
 */
export function mulVec4Scalar(v, s, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = v[0] * s;
 ...
 */
export function mulVec3Scalar(v, s, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = v[0] * s;
 ...
 */
export function mulVec2Scalar(v, s, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = v[0] * s;
 ...
 */
export function addVec3(u, v, dest) {
    if (!dest) {
        dest = u;
    }
    dest[0] = u[0] + v[0];
...
/**
 */
export function addVec3Scalar(v, s, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = v[0] + s;
 ...
 */
export function subVec4(u, v, dest) {
    if (!dest) {
        dest = u;
    }
    dest[0] = u[0] - v[0];
 ...
 */
export function compareVec3(v1, v2) {
    return (v1[0] === v2[0] && v1[1] === v2[1] && v1[2] === v2[2]);
}
/**
 * Subtracts one three-element vector from another.
 */
export function subVec3(u, v, dest) {
    if (!dest) {
        dest = u;
    }
    dest[0] = u[0] - v[0];
 ...
 */
export function subVec2(u, v, dest) {
    if (!dest) {
        dest = u;
    }
    dest[0] = u[0] - v[0];
 ...
 */
export function geometricMeanVec2(...vectors) {
 ...
 */
export function subVec4Scalar(v, s, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = v[0] - s;
 ...
 */
export function subScalarVec4(v, s, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = s - v[0];
 ...
 */
export function mulVec4(u, v, dest) {
    if (!dest) {
        dest = u;
    }
    dest[0] = u[0] * v[0];
 ...
 */
export function divVec3(u, v, dest) {
    if (!dest) {
        dest = u;
    }
    dest[0] = u[0] / v[0];
 ...
 */
export function divVec4(u, v, dest) {
    if (!dest) {
        dest = u;
    }
    dest[0] = u[0] / v[0];
 ...
 */
export function divScalarVec3(s, v, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = s / v[0];
 ...
 */
export function divVec3Scalar(v, s, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = v[0] / s;
 ...
 */
export function divVec4Scalar(v, s, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = v[0] / s;
 ...
 */
export function divScalarVec4(s, v, dest) {
    if (!dest) {
        dest = v;
    }
    dest[0] = s / v[0];
 ...
 */
export function dotVec4(u, v) {
    return (u[0] * v[0] + u[1] * v[1] + u[2] * v[2] + u[3] * v[3]);
}
/**
 * Returns the cross product of two four-element vectors.
 */
export function cross3Vec4(u, v) {
    const u0 = u[0];
    const u1 = u[1];
    const u2 = u[2];
    const v0 = v[0];
 ...
 */
export function cross3Vec3(u, v, dest) {
    if (!dest) {
        dest = u;
    }
    const x = u[0];
 ...
 * @return The length
 */
export function lenVec4(v) {
    return Math.sqrt(sqLenVec4(v));
}
/**
 * Returns the dot product of two two-element vectors.
 */
export function dotVec2(u, v) {
    return (u[0] * v[0] + u[1] * v[1]);
}
export function sqLenVec3(v) {
    return dotVec3(v, v);
}
export function sqLenVec2(v) {
    return dotVec2(v, v);
}
/**
 * Returns the length of a three-element vector.
 */
export function lenVec3(v) {
 ...
 */
export function lerpVec3(t, t1, t2, p1, p2, dest) {
 ...
 *
 */
export function rcpVec3(v, dest) {
 ...
 *
 */
export function normalizeVec4(v, dest) {
 ...
 * @static
 */
export function normalizeVec3(v, dest) {
 ...
 */
export function normalizeVec2(v, dest) {
 ...
 */
export const vec3FromMat4Scale = ((() => {
    const tempVec3 = createVec3();
 ...
 */
export function triangleNormal(a, b, c, normal = createVec3()) {
    const p1x = b[0] - a[0];
    const p1y = b[1] - a[1];
    const p1z = b[2] - a[2];
    const p2x = c[0] - a[0];
 ...
 */
export function createMat3(values) {
    // @ts-ignore
 ...
 */
export function mat3ToMat4(mat3, mat4) {
    if (!mat4) {
        mat4 = createMat4();
    }
    mat4[0] = mat3[0];
 ...
 */
export function createMat4(values) {
    // @ts-ignore
 ...
 * @returns {boolean}
 */
export function compareMat4(m1, m2) {
    return m1[0] === m2[0] &&
        m1[1] === m2[1] &&
        m1[2] === m2[2] &&
        m1[3] === m2[3] &&
 ...
 */
export function perspectiveMat4(fovyrad, aspectratio, znear, zfar, m) {
    const pmin = [];
    const pmax = [];
    pmin[2] = znear;
    pmax[2] = zfar;
 ...
 */
export function frustumMat4v(fmin, fmax, m) {
    if (!m) {
        m = createMat4();
    }
 ...
 */
export function orthoMat4c(left, right, bottom, top, near, far, dest) {
    if (!dest) {
        dest = createMat4();
    }
    const rl = (right - left);
 ...
 * Returns a 4x4 perspective projection matrix.
 */
export function frustumMat4(left, right, bottom, top, near, far, dest) {
    if (!dest) {
        dest = createMat4();
    }
    const rl = (right - left);
 ...
 */
export function identityMat4(dest) {
    if (!dest) {
        dest = createMat4();
    }
    dest[0] = 1.0;
 ...
 */
export function identityMat3(dest) {
    if (!dest) {
        dest = createMat4();
    }
    dest[0] = 1.0;
 ...
 */
export function rotationMat4v(anglerad, axis, m) {
    if (!m) {
        m = createMat4();
    }
 ...
 */
export function lookAtMat4v(pos, target, up, dest) {
    if (!dest) {
        dest = createMat4();
    }
    const posx = pos[0];
 ...
 */
export function inverseMat4(mat, dest) {
    if (!dest) {
        dest = mat;
    }
    const a00 = mat[0];
 ...
 */
export function transposeMat4(mat, dest) {
    const m4 = mat[4];
    const m14 = mat[14];
    const m8 = mat[8];
    const m13 = mat[13];
 ...
 */
export function mulMat4v4(m, v, dest) {
    if (!dest) {
        dest = m;
    }
    const v0 = v[0];
 ...
 * @static
 */
export function mulMat4(a, b, dest) {
    if (!dest) {
        dest = a;
    }
    const a00 = a[0];
 ...
 */
export function mulMat3(a, b, dest = newFloatArray(9)) {
    const a11 = a[0];
    const a12 = a[3];
    const a13 = a[6];
    const a21 = a[1];
 ...
 * @static
 */
export function transformPoint3(m, p, dest) {
    if (!dest) {
        dest = p;
    }
    const x = p[0];
 ...
 * @static
 */
export function transformPoint4(m, v, dest) {
 ...
 * @static
 */
export function transformPoints3(m, points, points2) {
 ...
 */
export function transformPositions3(m, p, p2) {
    if (!p2) {
        p2 = p;
    }
    let i;
 ...
 * Transforms an array of positions by a 4x4 matrix.
 */
export function transformPositions4(m, p, p2) {
    if (!p2) {
        p2 = p;
    }
    let i;
 ...
 */
export function transformVec3(m, v, dest) {
    const v0 = v[0];
    const v1 = v[1];
    const v2 = v[2];
 ...
 * @static
 */
export function transformVec4(m, v, dest) {
    const v0 = v[0];
    const v1 = v[1];
    const v2 = v[2];
    const v3 = v[3];
 ...
 */
export function scaleMat4v(xyz, m = identityMat4()) {
    const x = xyz[0];
    const y = xyz[1];
    const z = xyz[2];
    m[0] *= x;
...
/**
 */
export function scalingMat4v(v, m = identityMat4()) {
    m[0] = v[0];
    m[5] = v[1];
    m[10] = v[2];
    return m;
 ...
 */
export function scalingMat3v(v, m = identityMat3()) {
    m[0] = v[0];
    m[4] = v[1];
    return m;
}
 ...
 * @param m
 */
export function scaleMat4c(x, y, z, m) {
    m[0] *= x;
    m[4] *= y;
    m[8] *= z;
    m[1] *= x;
 ...
 */
export function scalingMat4s(s) {
 ...
 * @param mat
 */
export function composeMat4(position, quaternion, scale, mat = createMat4()) {
 ...
 * @param mat
 */
export function composeMat4Euler(position, rotation, scale, mat = createMat4()) {
 ...
 */
export function translateMat4v(xyz, m = identityMat4()) {
 ...
 */
export function translateMat4c(x, y, z, m = identityMat4()) {
    const m3 = m[3];
    m[0] += m3 * x;
    m[1] += m3 * y;
    m[2] += m3 * z;
 ...
 */
export function setMat4Translation(m, translation, dest) {
    dest[0] = m[0];
    dest[1] = m[1];
    dest[2] = m[2];
    dest[3] = m[3];
 ...
 */
export function translationMat4v(v, dest) {
 ...
 */
export function translationMat3v(v, dest) {
 ...
 * Returns 4x4 translation matrix.
 */
export function translationMat4s(s, dest) {
    return translationMat4c(s, s, s, dest);
}
/**
 * Returns the determinant of the given 4x4 matrix.
 */
export function determinantMat4(mat) {
    const a00 = mat[0];
    const a01 = mat[1];
    const a02 = mat[2];
    const a03 = mat[3];
 ...
 */
export function mat4ToEuler(mat, order, dest = createVec3()) {
 ...
 */
export function lerpMat4(t, t1, t2, m1, m2, dest) {
 ...
 */
export function identityQuat(dest = createVec4()) {
    dest[0] = 0.0;
    dest[1] = 0.0;
    dest[2] = 0.0;
    dest[3] = 1.0;
 ...
 */
export function eulerToQuat(euler, order, dest = createVec4()) {
 ...
 */
export function mat4ToQuat(m, dest = createVec4()) {
 ...
 * @param dest
 */
export function vec3PairToQuat(u, v, dest = createVec4()) {
 ...
 * @param dest
 */
export function angleAxisToQuaternion(angleAxis, dest = createVec4()) {
 ...
 * @param dest
 */
export function quatToEuler(q, order, dest = createVec3()) {
 ...
 * @param dest
 */
export function mulQuats(p, q, dest = createVec4()) {
    const p0 = p[0];
    const p1 = p[1];
    const p2 = p[2];
    const p3 = p[3];
 ...
 * @param dest
 */
export function vec3ApplyQuat(q, vec, dest = createVec3()) {
    const x = vec[0];
    const y = vec[1];
    const z = vec[2];
    const qx = q[0];
 ...
 * @param dest
 */
export function quatToMat4(q, dest) {
 ...
 * @param m
 */
export function quatToRotationMat4(q, m) {
    const x = q[0];
    const y = q[1];
    const z = q[2];
    const w = q[3];
 ...
 */
export function normalizeQuat(q, dest = q) {
 ...
 */
export function conjugateQuat(q, dest = q) {
    dest[0] = -q[0];
    dest[1] = -q[1];
    dest[2] = -q[2];
    dest[3] = q[3];
 ...
 */
export function inverseQuat(q, dest) {
 ...
 */
export function quatToAngleAxis(q, angleAxis = createVec4()) {
 ...
 */
export function rayTriangleIntersect(origin, dir, a, b, c, isect) {
 ...
 */
export function transformRay(matrix, rayOrigin, rayDir, rayOriginDest, rayDirDest) {
