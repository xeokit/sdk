import { createPrimsKdTree3, searchKdTree3WithFrustum } from "../kdtree3";
...
export class Picker {
    ...
    #getPrimsKdTree3(geometry, k) {
        ...
        if (!primsKdTree3) {
            const positions = decompressPositions3WithAABB3(geometry.positionsCompressed, geometry.aabb, new Float32Array(geometry.positionsCompressed.length));
            primsKdTree3 = {
