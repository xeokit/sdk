import { createVec3, createVec4, dotVec3, mulVec3Scalar, normalizeVec3, setMat4Translation, transformVec4, translateMat4v } from "../matrix";
 ...
 */
export function createRTCViewMat(viewMat, rtcCenter, rtcViewMat = tempMat) {
 ...
 */
export function worldToRTCPos(worldPos, rtcCenter, rtcPos) {
 ...
 */
export function worldToRTCCenter(worldCenter, rtcCenter, cellSize = RTC_CELL_SIZE) {
 ...
 */
export function worldToRTCPositions(worldPositions, rtcPositions, rtcCenter, cellSize = RTC_CELL_SIZE) {
 ...
 * @param worldPos The World-space position.
 */
export function rtcToWorldPos(rtcCenter, rtcPos, worldPos) {
 ...
 * @returns {*}
 */
export function getPlaneRTCPos(dist, dir, rtcCenter, rtcPlanePos) {
