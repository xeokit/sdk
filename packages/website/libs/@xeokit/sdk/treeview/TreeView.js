...
export class TreeView extends Component {
    ...
    constructor(params) {
        ...
        this.onNodeTitleClicked = new EventEmitter(new EventDispatcher());
        this.onContextMenu = new EventEmitter(new EventDispatcher());
        ...
        this.#checkboxChangeHandler = (event) => {
            ...
            while (parentNode) {
                parentNode.checked = visible;
                const checkbox2 = document.getElementById(parentNode.nodeId); // Parent checkboxes are always in DOM
                if (visible) {
