...
//     return query_string;
// }();
export function loadJSON(url, ok, err) {
...
export function loadArraybuffer(url, ok, err) {
    // Check for data: URI
    // @ts-ignore
    const defaultCallback = (_value) => undefined;
    ok = ok || defaultCallback;
 ...
 * @param filename
 */
export function saveArrayBuffer(arrayBuffer, filename) {
