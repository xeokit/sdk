...
import { addVec3, createMat4, createVec3, cross3Vec3, dotVec3, identityMat4, inverseMat4, lenVec3, lookAtMat4v, mulMat4, mulVec3Scalar, normalizeVec3, rotationMat4v, subVec3, transformPoint3, transposeMat4 } from "../matrix";
...
import { CustomProjectionType, FrustumProjectionType, OrthoProjectionType, PerspectiveProjectionType } from "../constants";
...
class Camera extends Component {
    ...
    constructor(view, cfg = {}) {
        super(view, cfg);
        this.onProjectionType = new EventEmitter(new EventDispatcher());
        this.onViewMatrix = new EventEmitter(new EventDispatcher());
        this.onProjMatrix = new EventEmitter(new EventDispatcher());
        this.onWorldAxis = new EventEmitter(new EventDispatcher());
        this.onFrustum = new EventEmitter(new EventDispatcher());
        this.view = view;
        this.#state = {
