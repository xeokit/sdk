 ...
 */
export declare class OrthoProjection extends Component implements Projection {
    #private;
    /**
     ...
     */
    fromParams(orthoProjectionParams: OrthoProjectionParams): void;
    /**
...
//# sourceMappingURL=OrthoProjection.d.ts.map
