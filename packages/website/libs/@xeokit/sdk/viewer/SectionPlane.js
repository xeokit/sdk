...
class SectionPlane extends Component {
    ...
    constructor(view, cfg = {}) {
        ...
        this.onPos = new EventEmitter(new EventDispatcher());
        this.onDir = new EventEmitter(new EventDispatcher());
        this.onActive = new EventEmitter(new EventDispatcher());
    }
    /**
...
export { SectionPlane };
//# sourceMappingURL=SectionPlane.js.map