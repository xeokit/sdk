...
class View extends Component {
    ...
    constructor(options) {
        ...
        const canvas = options.htmlElement ||
        ...
        this.#onTick = this.viewer.onTick.subscribe(() => {
            ...
            const newWindowSize = window.innerWidth !== lastWindowWidth ||
                window.innerHeight !== lastWindowHeight;
            const newViewSize = htmlElement.clientWidth !== lastViewWidth ||
                htmlElement.clientHeight !== lastViewHeight;
            const newViewPos = htmlElement.offsetLeft !== lastViewOffsetLeft ||
        ...
        this.onObjectXRayed = new EventEmitter(new EventDispatcher());
        this.onLayerCreated = new EventEmitter(new EventDispatcher());
        this.onLayerDestroyed = new EventEmitter(new EventDispatcher());
        this.onSectionPlaneCreated = new EventEmitter(new EventDispatcher());
        this.onSectionPlaneDestroyed = new EventEmitter(new EventDispatcher());
        this.onSnapshotStarted = new EventEmitter(new EventDispatcher());
        this.onSnapshotFinished = new EventEmitter(new EventDispatcher());
