...
class Scheduler {
    ...
    #viewersRenderInfo = {};
    // @ts-ignore
    #viewerIDMap = new Map(); // Ensures unique viewer IDs
    #taskQueue = new Queue(); // Task queue, which is pumped on each frame; tasks are pushed to it with calls to xeokit.schedule
    #taskBudget = 10; // Millisecs we're allowed to spend on tasks in each frame
    #lastTime = 0;
    #elapsedTime = 0;
    /**
     * @private
