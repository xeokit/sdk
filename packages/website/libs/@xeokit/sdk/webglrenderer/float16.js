...
ct = Uint16Array, ut = (...t) => n(z, ct, t), ft = Uint32Array, ht = Float32Array, lt = c([][g]()), at = t(lt.next), yt = t(function* () {
    // @ts-ignore
}().next), pt = c(lt), wt = DataView.prototype, gt = t(wt.getUint16), dt = t(wt.setUint16), vt = TypeError, bt = RangeError, At = Set, mt = At.prototype, Bt = t(mt.add), xt = t(mt.has), Et = WeakMap, Tt = Et.prototype, Ot = t(Tt.get), jt = t(Tt.has), It = t(Tt.set), Pt = new U(4), St = new ht(Pt), _t = new ft(Pt), Ft = new ft(512), Lt = new ft(512);
for (let t = 0; t < 256; ++t) {
    const r = t - 127;
...
function Rt(t) {
    St[0] = t;
    const r = _t[0], n = r >> 23 & 511;
    return Ft[n] + ((8388607 & r) >> Lt[n]);
}
const Ct = new ft(2048), Nt = new ft(64), Ut = new ft(64);
Ct[0] = 0;
...
for (let t = 1024; t < 2048; ++t)
    Ct[t] = 939524096 + (t - 1024 << 13);
Nt[0] = 0;
for (let t = 1; t < 31; ++t)
    Nt[t] = t << 23;
Nt[31] = 1199570944, Nt[32] = 2147483648;
for (let t = 33; t < 63; ++t)
    Nt[t] = 2147483648 + (t - 32 << 23);
...
function Dt(t) {
    if ("bigint" == typeof t)
        throw vt("Cannot convert a BigInt value to a number");
    if (t = y(t), !p(t) || 0 === t)
        return t;
    // @ts-ignore
    return Mt(Rt(t));
...
function tr(t, r) {
    if (!zt(t))
        throw vt("This is not an object");
    const n = t.constructor;
    if (void 0 === n)
        return r;
    if (!zt(n))
        throw vt("The constructor property value is not an object");
    const e = n[d];
    return null == e ? r : e;
}
function rr(t) {
...
const er = b("__Float16Array__"), or = new Et;
function ir(t) {
...
function sr(t) {
    if (!ir(t))
        throw vt("This is not a Float16Array object");
}
function cr(t, r) {
    const n = ir(t), e = Kt(t);
    if (!n && !e)
        throw vt("Species constructor didn't return TypedArray object");
    if ("number" == typeof r) {
        let e;
        if (n) {
            const r = ur(t);
            ...
            e = it(t);
        if (e < r)
            throw vt("Derived constructor created TypedArray object which was too small length");
    }
    if (Xt(t))
        throw vt("Cannot mix BigInt and other types, use explicit conversions");
}
function ur(t) {
    const r = Ot(or, t);
    if (void 0 !== r) {
        if (rr(et(r)))
            throw vt("Attempting to access detached ArrayBuffer");
        return r;
    }
    const n = t.buffer;
    if (rr(n))
...
class ar {
        ...
        if (ir(t))
            ...
            if (Kt(t)) {
                ...
                if (null != i && "function" != typeof i)
                    throw vt("@@iterator property is not callable");
                // @ts-ignore
    ...
    static from(t, ...r) {
        const e = this;
        if (!u(e, er))
            throw vt("This constructor is not a subclass of Float16Array");
        if (e === ar) {
            if (ir(t) && 0 === r.length) {
                const r = ur(t), n = new ct(et(r), ot(r), it(r));
                // @ts-ignore
                return new ar(et(rt(n)));
            }
            // @ts-ignore
            if (0 === r.length)
                return new ar(et(ut(t, Rt)));
            const e = r[0], o = r[1];
            // @ts-ignore
        ...
        // @ts-ignore
        if (null != s)
            Ht(t) ? (o = t, i = t.length) : !Kt(c = t) || c[g] !== K && "Array Iterator" !== c[g]()[v] ? (o = [...t], i = o.length) : (o = t, i = it(t));
        else {
            if (null == t)
                throw vt("Cannot convert undefined or null to object");
            o = A(t), i = $t(o.length);
        }
        var c;
        // @ts-ignore
    ...
    at(t) {
        sr(this);
        const r = ur(this), n = it(r), e = Zt(t), o = e >= 0 ? e : n + e;
        if (!(o < 0 || o >= n))
            return Mt(r[o]);
    }
    map(t, ...r) {
    ...
    reduce(t, ...r) {
        sr(this);
        const n = ur(this), e = it(n);
        if (0 === e && 0 === r.length)
            throw vt("Reduce of empty array with no initial value");
        let o, i;
    ...
    set(t, ...r) {
        sr(this);
        const n = ur(this), e = Zt(r[0]);
        if (e < 0)
            throw bt("Offset is out of bounds");
        if (null == t)
            throw vt("Cannot convert undefined or null to object");
        if (Xt(t))
            throw vt("Cannot mix BigInt and other types, use explicit conversions");
        if (ir(t))
            return J(ur(this), ur(t), e);
        if (Kt(t)) {
            if (rr(et(t)))
                throw vt("Attempting to access detached ArrayBuffer");
        }
        const o = it(n), i = A(t), s = $t(i.length);
        if (e === 1 / 0 || s + e > o)
            throw bt("Offset is out of bounds");
        for (let t = 0; t < s; ++t)
            n[t + e] = Rt(i[t]);
    ...
    sort(...t) {
        sr(this);
        const r = ur(this), n = void 0 !== t[0] ? t[0] : nr;
        // @ts-ignore
    ...
    slice(...t) {
        ...
        const e = it(r), o = Zt(t[0]), i = void 0 === t[1] ? e : Zt(t[1]);
        let s, c;
        s = o === -1 / 0 ? 0 : o < 0 ? e + o > 0 ? e + o : 0 : e < o ? e : o, c = i === -1 / 0 ? 0 : i < 0 ? e + i > 0 ? e + i : 0 : e < i ? e : i;
        const u = c - s > 0 ? c - s : 0, f = new n(u);
        if (cr(f, u), 0 === u)
            return f;
        if (rr(et(r)))
            throw vt("Attempting to access detached ArrayBuffer");
