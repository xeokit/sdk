...
export class VBORenderer {
    ...
    bind(renderPass) {
        ...
        if (uniforms.projMatrix) {
            gl.uniformMatrix4fv(uniforms.projMatrix, false, (renderPass === RENDER_PASSES.PICK
        ...
        if (saoEnabled) {
            if (this.uniforms.saoParams) {
                ...
                this.program.bindTexture(this.samplers.saoOcclusionTexture, renderContext.saoOcclusionTexture, renderContext.textureUnit);
