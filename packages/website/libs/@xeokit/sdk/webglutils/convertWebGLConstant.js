 ...
 * @param encoding
 */
export function convertWebGLConstant(gl, constantVal, encoding) {
    let extension;
    const p = constantVal;
...
//# sourceMappingURL=convertWebGLConstant.js.map