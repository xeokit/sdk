...
function createAircraftHUDStateAdapter({ view, vehicle }) {
  return () => {
...
function createDemoHUDModalRenderer() {
  return {
    mode: "navigation",
...
function createCombatJetHUD(params) {
...
//# sourceMappingURL=CombatJetHUD.js.map
