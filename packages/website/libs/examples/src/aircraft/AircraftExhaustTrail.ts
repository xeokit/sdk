...
type Scene = any;
type SceneModel = any;
type SceneTransform = any;
const DEFAULT_TRIANGLES_PRIMITIVE = 20002;
...
export interface AircraftExhaustTrailParams {
  ...
  /** xeokit TrianglesPrimitive constant. Defaults to the SDK numeric value. */
  trianglesPrimitive?: number;
  /** Optional xeokit geometry compression helper. Defaults to pass-through. */
  compressGeometryParams?: (params: any) => any;
}
...
export class AircraftExhaustTrail {
  ...
  private createAfterburner(afterburner: AircraftAfterburnerConfig, trianglesPrimitive: number, compressGeometryParams: (params: any) => any): void {
