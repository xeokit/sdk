...
import {buildVectorText} from "@xeokit/sdk/model/generation/buildGeometry/buildVectorText";
 ...
 *
 * See the website example Studio drawing tools for
  ...
  for (const objectId of Object.keys(sourceModel.objects)) {
    ...
    if (objFills) {
      for (const fill of objFills) {
        ...
        // path picks up MaterialMaps.flatColor when a generation
