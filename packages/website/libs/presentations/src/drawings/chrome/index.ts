 ...
 *   textured via a `generation.paintMaterials` painter.
 ...
 *
 * ```javascript
 * import { buildDrawing } from "../libs/presentations/dist/index.js";
 *
 * await buildDrawing({
 *   scene,
 ...
 * `MaterialMaps` triple from `generation.paintMaterials`
 ...
 *
 * ```javascript
 * import { paintBlueprint } from "@xeokit/sdk/model/generation/paintMaterials";
 *
 * await buildDrawing({
 *   // ...
 *   panel: {
