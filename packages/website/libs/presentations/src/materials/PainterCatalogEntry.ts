import type {MaterialMaps} from "@xeokit/sdk/model/generation/paintMaterials";
import type {HatchParams, HatchStyle} from "@xeokit/sdk/model/scene/hatchPattern";
...
export interface PainterCatalogEntry {
   ...
   * `generation/paintMaterials`} groups its painters into: `"Masonry"`,
