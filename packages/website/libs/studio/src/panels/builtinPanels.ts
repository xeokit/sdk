...
import type {DataFormatSchema} from "@xeokit/sdk/quality/dataModel";
import {getGlobalTaskRunner} from "@xeokit/sdk/base/core";
...
import type {SchedulePlayer} from "@xeokit/website-presentations/schedule";
import {SunStudyPanel} from "./sunStudyPanel/SunStudyPanel";
import {SunStudy, type AnnualSunPlayer} from "@xeokit/website-presentations/sunStudy";
...
import type {VoxelGrid, VectorGrid, SliceAxis} from "@xeokit/website-presentations/volumeOverlay";
import {makeDemoScalarField, makeDemoVectorField} from "@xeokit/website-presentations/volumeOverlay";
import type {AnalysisGrid, SkyModel} from "@xeokit/website-presentations/daylightAnalysis";
import type {Scene} from "@xeokit/sdk/model/scene";

import {DistanceMeasurementTool} from "@xeokit/sdk/tools/measurement/distance/DistanceMeasurementTool";
import type {DistanceMeasurementToolParams} from "@xeokit/sdk/tools/measurement/distance/DistanceMeasurementToolParams";
import {AngleMeasurementsTool} from "@xeokit/sdk/tools/measurement/angle/AngleMeasurementsTool";
import type {AngleMeasurementsToolParams} from "@xeokit/sdk/tools/measurement/angle/AngleMeasurementsToolParams";
import {TransformControls} from "@xeokit/sdk/viewing/transformControls";
import type {TransformControlsParams} from "@xeokit/sdk/viewing/transformControls";
...
export function registerBuiltinPanels(registry: PanelRegistry): void {
  ...
  registry.register("transformControls", {
    ...
    create: (ctx,  params) => TransformControls.openFor({
      view:           params.view,
      picker:         ctx.studio.picking.picker,
      modelNavigation: (ctx.studio.viewManager.views as any)?.[params.view.id]?.modelNavigation,
      ...params,
    }),
  });
}
