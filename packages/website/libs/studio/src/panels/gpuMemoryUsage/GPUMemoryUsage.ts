 ...
 *
 * Two collapsible sections: usage (allocated / used MB +
 * utilisation bar) and configs (tile size, batch limits, …).
 *
...
import type {
  MemoryConfigs,
  MemoryUsage,
} from "@xeokit/sdk/viewing/renderers/webGL";
import type {WebGPUMemoryStats} from "@xeokit/sdk/viewing/renderers/webGPU";
import type {Renderer} from "@xeokit/sdk/viewing/rendering";
import {clamp} from "@xeokit/sdk/base/math";
