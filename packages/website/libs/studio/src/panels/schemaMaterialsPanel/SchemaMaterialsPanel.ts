...
import type {Data, DataModel, DataObject} from "@xeokit/sdk/model/data";
import {applyIFCMaterials} from "../../systems/applyIFCMaterials/applyIFCMaterials";
import {removeAttachedMaterials} from "../../systems/applyIFCMaterials/removeAttachedMaterials";
import {DEFAULT_IFC_PAINTERS} from "../../systems/applyIFCMaterials/DEFAULT_IFC_PAINTERS";
import type {IfcPainterEntry} from "../../systems/applyIFCMaterials/IfcPainterEntry";
import {MaterialsPalette} from "@xeokit/website-presentations/materials/MaterialsPalette";
import type {PainterCatalogEntry} from "@xeokit/website-presentations/materials/PainterCatalogEntry";
 ...
 * sorted by id for stable tab order across refreshes. See
 * {@link isDefaultLayerModel} for the whitelist semantics —
 * named ViewLayers (tool overlays, annotations, comparisons)
 * are skipped.
 */
