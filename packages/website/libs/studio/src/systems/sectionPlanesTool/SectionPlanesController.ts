...
import type {TransformControlsSpace} from "@xeokit/sdk/viewing/transformControls";
import type {SectionPlane, View, Viewer} from "@xeokit/sdk/viewing/viewer";
...
export interface SectionPlanesControllerOptions {
   ...
   * picker and ModelNavigationController wiring as object transform editing.
   */
