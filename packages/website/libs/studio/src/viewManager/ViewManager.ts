import type {PickParams, PickResult, View, Viewer, ViewParams} from "@xeokit/sdk/viewing/viewer";
import type {SDKResult} from "@xeokit/sdk/base/core";
import type {AABB3Float} from "@xeokit/sdk/base/math/boundaries";
import {CameraFlightAnimation} from "@xeokit/sdk/viewing/cameraFlight";
import {ModelNavigationController} from "@xeokit/sdk/viewing/navigation/model";
import type {WalkNavigationController} from "@xeokit/sdk/viewing/navigation/walk";
import type {VehicleNavigationController} from "@xeokit/sdk/viewing/navigation/vehicle";
 ...
 * their {@link ModelNavigationController}s.
 */
export interface ViewManagerContext {
  viewer: Viewer;

  /**
   * Picking function handed to every {@link ModelNavigationController}. Routed
...
export interface ViewManagerHooks {
   ...
   * ModelNavigationController have all been constructed and recorded.
 ...
 * ModelNavigationController construction, and DOM hosting all at once. Splitting
...
export class ViewManager {
   ...
   * `viewManager.views[id].cameraFlight` / `.modelNavigation`.
   */
  ...
  createView(viewParams: StudioCreateViewParams = {}): View {
    ...
    const record: ViewRecord = {
      view,
      cameraFlight,
      modelNavigation: new ModelNavigationController(view, {
