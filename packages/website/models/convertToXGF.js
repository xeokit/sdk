...
// any separate model.optimized.xgf is dropped. After conversion, buildIndex.js
...
//
// Run from anywhere:
//   node packages/website/models/convertToXGF.js
//
...
const XEOCONVERT = path.resolve(__dirname, "../../sdk/dist/xeoconvert/xeoconvert.js");
const BUILD_INDEX = path.join(MODELS_DIR, "buildIndex.js");
const SUMMARY_FILE = path.join(MODELS_DIR, "convert-to-xgf-report.json");
const POLYFILLS = path.join(MODELS_DIR, "_convert-polyfills.cjs");
