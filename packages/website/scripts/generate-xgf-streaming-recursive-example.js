...
const {readXGFStreamingRuntimeIndex} = require("../../sdk/src/formats/xgfstream/index/readXGFStreamingRuntimeIndex");
const {createCoordinateSystemTransform} = require("../../sdk/src/model/scene/createCoordinateSystemTransform");
const {createMat4Float64, transformPoint3} = require("../../sdk/src/base/math/matrix");
