...
async function loadThresholds(): Promise<CalibrationThresholds> {
  const thresholdPath = path.join(rootDir, "packages/website/scripts/procedural-city/calibration/regression-thresholds.json");
  try {
...
function printHelp(): void {
  console.log(`Usage:
  node packages/website/scripts/procedural-city/calibrate-city.mjs [options]
