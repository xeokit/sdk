...
function createOpenSpace(block: Block, streams: RandomStreams): CityObject {
  ...
  meshes.push(treeTrunks.toMesh("tree-trunk", "park-tree-trunks"));
  meshes.push(treeCrowns.toMesh("tree-canopy", "park-tree-canopies"));
  meshes.push(furniture.toMesh(block.openSpace?.includes("plaza") ? "limestone" : "street-furniture", "park-furniture"));
