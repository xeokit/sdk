...
```bash
node packages/website/tools/building-generator/analyze-style.js
```

By default this writes:

```text
packages/website/tools/building-generator/building-style.json
```
...
```bash
node packages/website/tools/building-generator/build-procedural-buildings.js
```
...
node packages/website/tools/building-generator/build-procedural-buildings.js \
  --count 16 \
  --seed 7 \
  --profile packages/website/tools/building-generator/building-style.json
```
