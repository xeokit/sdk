...
* Scene graph that contains model representations (geometries, materials etc.)
* [npm module](https://www.npmjs.com/package/@xeokit/scene) | [API docs](https://xeokit.github.io/sdk/docs/modules/_xeokit_scene.html)

| NPM Packages                                                 | Documentation                                                            | Description                                                                  |
|--------------------------------------------------------------|---------------------------------------------------------------------------------|------------------------------------------------------------------------------|
