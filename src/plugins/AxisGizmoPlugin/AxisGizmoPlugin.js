 ...
 *
 * ````JavaScript````
 * import {Viewer, XKTLoaderPlugin, AxisGizmoPlugin} from "xeokit-viewer.es.js";
 *
...
class AxisGizmoPlugin extends Plugin {
    ...
    constructor(viewer, cfg) {
        ...
        const arrowHead = new Geometry(axisGizmoScene, buildCylinderGeometry({
            radiusTop: 0.01,
            radiusBottom: 0.6,
            height: 1.7,
            radialSegments: 20,
        ...
        const arrowShaft = new Geometry(axisGizmoScene, buildCylinderGeometry({
            radiusTop: 0.2,
            radiusBottom: 0.2,
            height: 4.5,
            radialSegments: 20,
        ...
        this._meshes = [
            ...
            new Mesh(axisGizmoScene, {
                geometry: new Geometry(axisGizmoScene, buildSphereGeometry({
                    radius: 9.0,
                    heightSegments: 60,
                    widthSegments: 60
                })),
            ...
            new Mesh(axisGizmoScene, {  // Label
                geometry: new Geometry(axisGizmoScene, buildVectorTextGeometry({text: "X", size: 1.5})),
            ...
            new Mesh(axisGizmoScene, {  // Label
                geometry: new Geometry(axisGizmoScene, buildVectorTextGeometry({text: "Y", size: 1.5})),
            ...
            new Mesh(axisGizmoScene, {  // Label
                geometry: new Geometry(axisGizmoScene, buildVectorTextGeometry({text: "Z", size: 1.5})),
