...
class Control {
    ...
    _createNodes() {
        ...
        const shapes = {// Reusable geometries
            ...
            arrowHead: new Geometry(rootNode, buildCylinderGeometry({
                radiusTop: 0.001,
            ...
            arrowHeadBig: new Geometry(rootNode, buildCylinderGeometry({
                radiusTop: 0.001,
                radiusBottom: 0.09,
                radialSegments: 32,
                heightSegments: 1,
            ...
            arrowHeadHandle: new Geometry(rootNode, buildCylinderGeometry({
                radiusTop: 0.09,
                radiusBottom: 0.09,
                radialSegments: 8,
                heightSegments: 1,
            ...
            curve: new Geometry(rootNode, buildTorusGeometry({
                radius: hoopRadius,
                tube: tubeRadius,
                radialSegments: 64,
                tubeSegments: 14,
            ...
            curveHandle: new Geometry(rootNode, buildTorusGeometry({
                radius: hoopRadius,
            ...
            hoop: new Geometry(rootNode, buildTorusGeometry({
                radius: hoopRadius,
                tube: tubeRadius,
                radialSegments: 64,
                tubeSegments: 8,
            ...
            axis: new Geometry(rootNode, buildCylinderGeometry({
            ...
            axisHandle: new Geometry(rootNode, buildCylinderGeometry({
                radiusTop: 0.08,
                radiusBottom: 0.08,
                radialSegments: 20,
                heightSegments: 1,
        ...
        this._displayMeshes = {
            ...
            plane: rootNode.addChild(new Mesh(rootNode, {
                geometry: new Geometry(rootNode, {
                    primitive: "triangles",
                    positions: [
            ...
            planeFrame: rootNode.addChild(new Mesh(rootNode, { // Visible frame
                geometry: new Geometry(rootNode, buildTorusGeometry({
                    center: [0, 0, 0],
                    radius: 1.7,
                    tube: tubeRadius * 2,
                    radialSegments: 4,
            ...
            center: rootNode.addChild(new Mesh(rootNode, {
                geometry: new Geometry(rootNode, buildSphereGeometry({
                    radius: 0.05
                })),
