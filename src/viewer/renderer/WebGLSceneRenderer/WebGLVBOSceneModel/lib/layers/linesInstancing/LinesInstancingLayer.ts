...
import {WebGLSceneRendererDrawable} from "../../../../WebGLSceneRendererDrawable";
 ...
 * @private
 */
class LinesInstancingLayer implements WebGLSceneRendererDrawable, WebGLSceneRendererPickable {
