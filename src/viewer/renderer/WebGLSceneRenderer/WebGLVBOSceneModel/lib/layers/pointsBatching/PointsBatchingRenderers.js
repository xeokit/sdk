...
class PointsBatchingRenderers {
    ...
    get colorRenderer() {
        if (!this._colorRenderer) {
            this._colorRenderer = new PointsBatchingColorRenderer(this.#scene);
        }
    ...
    get silhouetteRenderer() {
        if (!this._silhouetteRenderer) {
            this._silhouetteRenderer = new PointsBatchingSilhouetteRenderer(this.#scene);
        }
    ...
    get pickMeshRenderer() {
        if (!this._pickMeshRenderer) {
            this._pickMeshRenderer = new PointsBatchingPickMeshRenderer(this.#scene);
        }
    ...
    get pickDepthRenderer() {
        if (!this._pickDepthRenderer) {
            this._pickDepthRenderer = new PointsBatchingPickDepthRenderer(this.#scene);
        }
    ...
    get occlusionRenderer() {
        if (!this._occlusionRenderer) {
            this._occlusionRenderer = new PointsBatchingOcclusionRenderer(this.#scene);
        }
