...
class PointsInstancingRenderers {
    ...
    get colorRenderer() {
        if (!this._colorRenderer) {
            this._colorRenderer = new PointsInstancingColorRenderer(this.#scene, false);
        }
    ...
    get silhouetteRenderer() {
        if (!this._silhouetteRenderer) {
            this._silhouetteRenderer = new PointsInstancingSilhouetteRenderer(this.#scene);
        }
    ...
    get depthRenderer() {
        if (!this._depthRenderer) {
            this._depthRenderer = new PointsInstancingDepthRenderer(this.#scene);
        }
    ...
    get pickMeshRenderer() {
        if (!this._pickMeshRenderer) {
            this._pickMeshRenderer = new PointsInstancingPickMeshRenderer(this.#scene);
        }
    ...
    get pickDepthRenderer() {
        if (!this._pickDepthRenderer) {
            this._pickDepthRenderer = new PointsInstancingPickDepthRenderer(this.#scene);
        }
    ...
    get occlusionRenderer() {
        if (!this._occlusionRenderer) {
            this._occlusionRenderer = new PointsInstancingOcclusionRenderer(this.#scene);
        }
    ...
    get shadowRenderer() {
        if (!this._shadowRenderer) {
            this._shadowRenderer = new PointsInstancingShadowRenderer(this.#scene);
        }
