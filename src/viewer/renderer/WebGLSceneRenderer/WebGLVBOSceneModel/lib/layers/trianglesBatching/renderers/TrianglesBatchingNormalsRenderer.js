...
class TrianglesBatchingNormalsRenderer {
    ...
    drawLayer(frameCtx, batchingLayer, renderPass) {
        ...
        gl.uniformMatrix4fv(this._uPositionsDecompressMatrix, false, batchingLayer.state.positionsDecompressMatrix);
    ...
    _allocate() {
        ...
        this._uPositionsDecompressMatrix = program.getLocation("positionsDecompressMatrix");
