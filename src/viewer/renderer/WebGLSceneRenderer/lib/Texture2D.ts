...
/**
 * A low-level component that represents a 2D WebGL texture.
 *
 * @private
 */
class Texture2D {
    ...
    constructor(cfg: {
        ...
        wrapT?: number,
        wrapR?: number,
        preloadColor?: math.FloatArrayType,
        ...
        this.target = cfg.target || cfg.gl.TEXTURE_2D;
        this.format = cfg.format || RGBAFormat;
        this.type = cfg.type || UnsignedByteType;
        this.internalFormat = null;
        this.premultiplyAlpha = !!cfg.premultiplyAlpha;
        ...
        this.texture = cfg.gl.createTexture();

        if (cfg.preloadColor) {
            this.setPreloadColor(cfg.preloadColor); // Prevents "there is no texture bound to the unit 0" error
        }
