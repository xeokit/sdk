 ...
 * ## Usage
 *
 * In the example below we'll create a {@link Mesh} with {@link PhongMaterial}, {@link Texture} and a {@link Geometry} loaded from 3DS.
 *
 * [[Run this example](http://xeokit.github.io/xeokit-sdk/examples/#geometry_loaders_3DS)]
 *
 * ````javascript
 * import {Viewer, Mesh, load3DSGeometry, Geometry, PhongMaterial, Texture} from "xeokit-sdk.es.js";
 *
 ...
 *
 *          geometry: new Geometry(viewer.scene, geometryCfg),
 *
