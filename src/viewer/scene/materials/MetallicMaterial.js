 ...
 * ## Usage
 *
 * In the example below we'll create a {@link Mesh} with {@link MetallicMaterial} and {@link Geometry} loaded from OBJ.
 *
 ...
 *
 * ````javascript
 * import {Viewer, Mesh, loadOBJGeometry, Geometry, MetallicMaterial, Texture} from "xeokit-sdk.es.js";
 *
 ...
 *
 *          geometry: new Geometry(viewer.scene, geometry),
 *
...
class MetallicMaterial extends Material {
     ...
     * @param {Number} [cfg.lineWidth=1] Scalar that controls the width of lines for {@link Geometry} with {@link Geometry#primitive} set to "lines".
...
*
    ...
    destroy() {
        super.destroy();
        this._putStateSortId(this._state.stateSortId);
    }
}
