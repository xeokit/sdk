 ...
 * ## Usage
 *
 * In this example we have a Mesh with a {@link PhongMaterial} which applies diffuse {@link Texture}, and a {@link buildTorusGeometry} which builds a {@link Geometry}.
 *
 ...
 * provide the diffuse and specular components for each fragment across the {@link Geometry} surface.
 *
 * [[Run this example](http://xeokit.github.io/xeokit-sdk/examples/#materials_Texture)]
 *
 * ```` javascript
 * import {Viewer, Mesh, buildTorusGeometry,
 *      Geometry, PhongMaterial, Texture} from "xeokit-sdk.es.js";
 *
