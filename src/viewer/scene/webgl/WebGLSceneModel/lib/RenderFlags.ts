 ...
 *
 * Each WebGLSceneModel has a RenderFlags in {@link WebGLVBOSceneModel.renderFlags}.
 *
 ...
 *
 * Then, when rendering a frame, Renderer will apply rendering passes to each WebGLSceneModel according on what flags are set in {@link WebGLVBOSceneModel.renderFlags}.
 *
 * @private
 */
class RenderFlags {
