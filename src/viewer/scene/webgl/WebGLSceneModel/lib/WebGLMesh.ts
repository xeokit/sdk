...
class WebGLMesh implements WebGLSceneRendererPickableMesh {
    ...
    drawPickTriangles(renderFlags: any, frameContext: any) {
        // NOP
    }
    ...
    drawPickDepths(renderFlags: RenderFlags, frameContext: FrameContext) {
