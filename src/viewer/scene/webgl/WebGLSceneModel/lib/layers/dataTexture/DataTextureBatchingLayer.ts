 ...
 * @private
 */
export class DataTextureBatchingLayer {
    layerIndex: number;
    ...
    constructor(cfg: BatchingLayerParams, renderers: any) {

        this.#renderers = renderers;
        this.#buffer = new BatchingBuffer(cfg.maxGeometryBatchSize);
        this.#scratchMemory = cfg.scratchMemory;

        this.layerIndex = cfg.layerIndex;
        this.sceneModel = cfg.sceneModel;
        this.sortId = "DataTextureBatchingLayer";
    ...
    draw(rendererType: number, renderFlags: RenderFlags, frameContext: FrameContext): void {
    ...
    drawShadow(renderFlags: RenderFlags, frameContext: FrameContext): void {
    }
