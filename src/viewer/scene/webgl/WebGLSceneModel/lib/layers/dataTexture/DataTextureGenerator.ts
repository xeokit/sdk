...
export class DataTextureGenerator {
     ...
     * @private
     */
    disableBindedTextureFiltering(gl: WebGL2RenderingContext) {
     ...
     */
    generateCameraDataTexture(gl: WebGL2RenderingContext, camera: Camera, scene: Scene, origin: any): BindableDataTexture {
     ...
     */
    generateModelDataTexture(gl: WebGL2RenderingContext, sceneModel: SceneModel): BindableDataTexture {
        const textureWidth = 4;
     ...
     */
    generateTextureForColorsAndFlags(gl: WebGL2RenderingContext, colors: any[], pickColors: ArrayLike<number>[], vertexBases: any[], indexBaseOffsets: any[], edgeIndexBaseOffsets: any[]): BindableDataTexture {
    ...
    generateTextureForObjectOffsets(gl: WebGL2RenderingContext, offsets: string | any[]) {
     ...
     */
    generateTextureForPositionsDecodeMatrices(gl: WebGL2RenderingContext, positionDecodeMatrices: string | any[], instanceMatrices: any[], instancesNormalMatrices: any[]): BindableDataTexture {
    ...
    generateTextureFor8BitIndices(gl: WebGL2RenderingContext, indices: any[] | ArrayLike<number>): BindableDataTexture {
        if (indices.length == 0) {
            return {
                // @ts-ignore
                texture: null,
    ...
    generateTextureFor16BitIndices(gl: WebGL2RenderingContext, indices: any[]): BindableDataTexture {
        if (indices.length == 0) {
            return {
                // @ts-ignore
                texture: null,
    ...
    generateTextureFor32BitIndices(gl: WebGL2RenderingContext, indices: any[]): BindableDataTexture {
        if (indices.length == 0) {
            return {
                // @ts-ignore
                texture: null,
    ...
    generateTextureFor8BitsEdgeIndices(gl: WebGL2RenderingContext, edgeIndices: any[]): BindableDataTexture {
    ...
    generateTextureFor16BitsEdgeIndices(gl: WebGL2RenderingContext, edgeIndices: any[]): BindableDataTexture {
        if (edgeIndices.length == 0) {
            return {
                // @ts-ignore
                texture: null,
    ...
    generateTextureFor32BitsEdgeIndices(gl: WebGL2RenderingContext, edgeIndices: any[]): BindableDataTexture {
        if (edgeIndices.length == 0) {
            return {
                // @ts-ignore
                texture: null,
    ...
    generateTextureForPositions(gl: WebGL2RenderingContext, positions: math.FloatArrayType[]): BindableDataTexture {
    ...
    generateTextureForPackedPortionIds(gl: WebGL2RenderingContext, portionIdsArray: any[]): BindableDataTexture {
