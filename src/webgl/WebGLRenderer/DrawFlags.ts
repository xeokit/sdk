 ...
 *
 * Before rendering each frame, {@link WebGLRenderer} will call {@link WebGLSceneModel.rebuildDrawFlags} on each {@link WebGLSceneModel}.
 *
 * Then, when rendering a frame, Renderer will apply rendering passes to each WebGLSceneModel according on what flags are set in {@link WebGLSceneModel.drawFlags}.
 *
 * @private
 */
class DrawFlags {
