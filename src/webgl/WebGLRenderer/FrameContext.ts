...
class FrameContext {
    ...
    #rtcViewMats: { [key: string]: math.FloatArrayType };
    #rtcPickViewMats: { [key: string]: math.FloatArrayType };
     ...
     */
    getRTCViewMatrix(originHash: string, origin: math.FloatArrayType): math.FloatArrayType {
     ...
     */
    getRTCPickViewMatrix(originHash: string, origin: math.FloatArrayType): math.FloatArrayType {
