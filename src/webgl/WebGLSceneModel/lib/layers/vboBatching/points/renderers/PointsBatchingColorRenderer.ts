 ...
 * @private
 */
export class PointsBatchingColorRenderer extends BasicVBOLayerRenderer {
    ...
    buildVertexShader(): string {
        ...
        src.push("// PointsBatchingColorRenderer");
        ...
        if (this.view.pointsMaterial.filterIntensity) {
        ...
        // if (this.view.entityOffsetsEnabled) {
        ...
        if (this.view.pointsMaterial.perspectivePoints) {
            ...
            src.push("gl_PointSize = max(gl_PointSize, " + Math.floor(this.view.pointsMaterial.minPerspectivePointSize) + ".0);");
            src.push("gl_PointSize = min(gl_PointSize, " + Math.floor(this.view.pointsMaterial.maxPerspectivePointSize) + ".0);");
        } else {
