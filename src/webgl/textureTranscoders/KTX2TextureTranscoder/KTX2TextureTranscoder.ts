...
import {Texture2D} from "../../../scene/webgl/lib/Texture2D";
...
class KTX2TextureTranscoder {
    ...
    private static EngineFormat: number;
    private static TranscoderFormat: number;
    private static BasisFormat: number;
