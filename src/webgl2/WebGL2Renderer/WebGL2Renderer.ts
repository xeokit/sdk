...
import {WebGL2SceneModel} from "../WebGL2SceneModel/WebGL2SceneModel";
...
import {ViewerCapabilities} from "../../viewer/ViewerCapabilities";
import {vec3} from "../../viewer/math/vector";
import {apply} from "../../viewer/utils/utils";
...
export class WebGL2Renderer implements Renderer {
    ...
    getCapabilities(capabilities: ViewerCapabilities): void {
        ...
        if (gl) {
            ...
            capabilities.etc1Supported = true; // WebGL2
