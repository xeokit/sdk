...
import {ArrayBuf} from "../../../lib/ArrayBuf.ts";
import {vec3} from "../../../../../dist/viewer/math";
import {AABB3, collapseAABB3, expandAABB3Points3} from "../../../../../dist/viewer/math/boundaries";
...
class OcclusionLayer {
    ...
    _buildAABB() {
        ...
        collapseAABB3(aabb);
        expandAABB3Points3(aabb, this.positions);
