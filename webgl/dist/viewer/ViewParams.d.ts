...
/**
 * {@link View} creation parameters for {@link WebViewer.createView}.
 */
export interface ViewParams {
     ...
     * viewLayerId. This default setting therefore ensures that a ViewObject is created in the {@link View} for every ViewerObject that is created.
     *
     * If you set this ````false````, however, then the {@link View} will only create {@link ViewObject|ViewObjects} for {@link ViewerObject|ViewerObjects} that have
