...
/**
 * Mesh creation parameters for {@link ViewerModel.createMesh}.
 */
export interface MeshParams {
    /**
     * ID for the mesh, unique within the {@link ViewerModel}.
     */
    id: string;
    /**
     * ID of a texture set that was created previously with {@link ViewerModel.createTextureSet}.
     */
    textureSetId?: string;
    /**
     * ID of a geometry that was created previously with {@link ViewerModel.createGeometry} or {@link ViewerModel.createGeometryCompressed}.
     */
    geometryId: string;
    /**
     * Optional ID of a {@link Transform} previously created with {@link ViewerModel.createTransform}.
     */
    transformId?: string;
    /**
     ...
     *
     * This is used internally within {@link ViewerModel}.
     */
    ...
    roughness?: number;
    /**
     * Optional 3D World-space origin, relative to {@link ViewerModel.origin}.
     *
