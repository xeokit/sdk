/**
 * Texture set creation parameters for {@link ViewerModel.createTextureSet}.
 */
export interface TextureSetParams {
    ...
    id: string;
    /**
     * ID of a color texture created previously with {@link ViewerModel.createTexture}.
     *
     * A color texture has color in *RGB* and alpha in *A*.
     */
    colorTextureId?: string;
    /**
     * ID of a metallic-roughness texture created previously with {@link ViewerModel.createTexture}.
     *
    ...
    /**
     * ID of an ambient occlusion texture created previously with {@link ViewerModel.createTexture}.
     *
     * An occlusion texture has *RGBA* components, with occlusion factor in *R*,
     */
    occlusionTextureId?: string;
    /**
     * ID of a normal map texture created previously with {@link ViewerModel.createTexture}.
     *
     * A normal map texture has *RGBA* components, with the normal map vectors in *RGB*.
     */
    normalsTextureId?: string;
    /**
     * ID of an emissive color texture created previously with {@link ViewerModel.createTexture}.
     *
